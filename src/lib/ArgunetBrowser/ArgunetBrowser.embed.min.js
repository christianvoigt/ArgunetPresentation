window.lightningjs||function(b,a){var c=b.lightningjs={modules:a.modules},e=a.modules;c.expensive=function(d){d._waitforload=!0;return d};c.require=a.require;c.provide=function(x,t){function s(){var g=b.console;if(g&&g.error){try{g.error.apply(g,arguments)}catch(k){}}else{if(b.opera){try{b.opera.postError.apply(b.opera,arguments)}catch(h){}}}}function u(C){var A=C[0],q=C[1],B=q>0?j[q]:t,r=Array.prototype.slice.call(C[2]),y=r.shift();C=w._.fh[A]=w._.fh[A]||[];q=w._.eh[A]=w._.eh[A]||[];w._.ph[A]=w._.ph[A]||[];var z,o;if(B){if(B=B[y]){try{z=B.apply(B,r)}catch(l){o=l}}else{o=Error("unknown deferred method '"+y+"'"),s(o.toString())}z&&(j[A]=z);if(o){for(;q.length;){A=q.shift();try{A(o)}catch(k){s(k)}}q.push=function(g){g(o)}}else{for(;C.length;){A=C.shift();try{A(z)}catch(h){s(h)}}C.push=function(g){g(z)}}}else{s("cannot call deferred method '"+y+"' on 'undefined'")}}function i(){for(var h=v.shift();h;){var m;if(f){m=!1}else{var g=h[1];m=g>0?j[g]:t;var l=Array.prototype.slice.call(h[2]).shift(),k=void 0;g=d[g]?!0:!1;m=m?(k=m[l])?k._waitforload?!0:!1:!1:g?!0:!1}m?(d[h[0]]=!0,n.push(h)):u(h);h=v.shift()}}c.require(x);var w=e[x];if(w.provided){s("deferred module '"+x+"' is already defined")}else{w.provided=!0;var v=(w._.s||[]).slice(),j={0:t},n=[],d={},f=!1;v&&v[0]&&(j[v[0][1]]=t);t._load=function(){f=!0;for(var g=n.shift();g;){u(g),g=n.shift()}};w._.s={push:function(g){v.push(g);i()}};i()}};e.lightningjs.provided||c.provide("lightningjs",{load:function(){var g=a.modules,i,h;for(h in g){i=g[h],i._&&i("_load")}}})}(window,window.parent.lightningjs);window.Modernizr=(function(n,t,i){var e="2.6.2",l={},D=t.documentElement,E="modernizr",B=t.createElement(E),o=B.style,f,w={}.toString,y=" -webkit- -moz- -o- -ms- ".split(" "),c="Webkit Moz O ms",G=c.split(" "),p=c.toLowerCase().split(" "),j={},d={},u={},A=[],v=A.slice,b,z=function(Q,S,K,R){var J,P,M,N,I=t.createElement("div"),O=t.body,L=O||t.createElement("body");if(parseInt(K,10)){while(K--){M=t.createElement("div");M.id=R?R[K]:E+(K+1);I.appendChild(M)}}J=["&#173;",'<style id="s',E,'">',Q,"</style>"].join("");I.id=E;(O?I:L).innerHTML+=J;L.appendChild(I);if(!O){L.style.background="";L.style.overflow="hidden";N=D.style.overflow;D.style.overflow="hidden";D.appendChild(L)}P=S(I,Q);if(!O){L.parentNode.removeChild(L);D.style.overflow=N}else{I.parentNode.removeChild(I)}return !!P},s=(function(){var J={select:"input",change:"input",submit:"form",reset:"form",error:"img",load:"img",abort:"img"};function I(K,M){M=M||t.createElement(J[K]||"div");K="on"+K;var L=K in M;if(!L){if(!M.setAttribute){M=t.createElement("div")}if(M.setAttribute&&M.removeAttribute){M.setAttribute(K,"");L=k(M[K],"function");if(!k(M[K],"undefined")){M[K]=i}M.removeAttribute(K)}}M=null;return L}return I})(),r=({}).hasOwnProperty,C;if(!k(r,"undefined")&&!k(r.call,"undefined")){C=function(I,J){return r.call(I,J)}}else{C=function(I,J){return((J in I)&&k(I.constructor.prototype[J],"undefined"))}}if(!Function.prototype.bind){Function.prototype.bind=function H(K){var L=this;if(typeof L!="function"){throw new TypeError()}var I=v.call(arguments,1),J=function(){if(this instanceof J){var O=function(){};O.prototype=L.prototype;var N=new O();var M=L.apply(N,I.concat(v.call(arguments)));if(Object(M)===M){return M}return N}else{return L.apply(K,I.concat(v.call(arguments)))}};return J}}function q(I){o.cssText=I}function h(J,I){return q(y.join(J+";")+(I||""))}function k(J,I){return typeof J===I}function m(J,I){return !!~(""+J).indexOf(I)}function F(K,I){for(var J in K){var L=K[J];if(!m(L,"-")&&o[L]!==i){return I=="pfx"?L:true}}return false}function x(J,M,L){for(var I in J){var K=M[J[I]];if(K!==i){if(L===false){return J[I]}if(k(K,"function")){return K.bind(L||M)}return K}}return false}function a(M,I,L){var J=M.charAt(0).toUpperCase()+M.slice(1),K=(M+" "+G.join(J+" ")+J).split(" ");if(k(I,"string")||k(I,"undefined")){return F(K,I)}else{K=(M+" "+(p).join(J+" ")+J).split(" ");return x(K,I,L)}}j.canvas=function(){var I=t.createElement("canvas");return !!(I.getContext&&I.getContext("2d"))
};j.canvastext=function(){return !!(l.canvas&&k(t.createElement("canvas").getContext("2d").fillText,"function"))};for(var g in j){if(C(j,g)){b=g.toLowerCase();l[b]=j[g]();A.push((l[b]?"":"no-")+b)}}l.addTest=function(J,K){if(typeof J=="object"){for(var I in J){if(C(J,I)){l.addTest(I,J[I])}}}else{J=J.toLowerCase();if(l[J]!==i){return l}K=typeof K=="function"?K():K;if(typeof enableClasses!=="undefined"&&enableClasses){D.className+=" "+(K?"":"no-")+J}l[J]=K}return l};q("");B=f=null;l._version=e;l._prefixes=y;l._domPrefixes=p;l._cssomPrefixes=G;l.hasEvent=s;l.testProp=function(I){return F([I])};l.testAllProps=a;l.testStyles=z;l.prefixed=function(K,J,I){if(!J){return a(K,"pfx")}else{return a(K,J,I)}};return l})(this,this.document);
/*!
...
this.buttonElement.removeClass(i+" "+c+" "+g).removeAttr("role").removeAttr("aria-pressed").html(this.buttonElement.find(".ui-button-text").html());if(!this.hasTitle){this.buttonElement.removeAttr("title")}},_setOption:function(l,m){this._super(l,m);if(l==="disabled"){if(m){this.element.prop("disabled",true)}else{this.element.prop("disabled",false)}return}this._resetButton()},refresh:function(){var l=this.element.is("input, button")?this.element.is(":disabled"):this.element.hasClass("ui-button-disabled");if(l!==this.options.disabled){this._setOption("disabled",l)}if(this.type==="radio"){d(this.element[0]).each(function(){if(f(this).is(":checked")){f(this).button("widget").addClass("ui-state-active").attr("aria-pressed","true")}else{f(this).button("widget").removeClass("ui-state-active").attr("aria-pressed","false")}})}else{if(this.type==="checkbox"){if(this.element.is(":checked")){this.buttonElement.addClass("ui-state-active").attr("aria-pressed","true")}else{this.buttonElement.removeClass("ui-state-active").attr("aria-pressed","false")}}}},_resetButton:function(){if(this.type==="input"){if(this.options.label){this.element.val(this.options.label)}return}var p=this.buttonElement.removeClass(g),n=f("<span></span>",this.document[0]).addClass("ui-button-text").html(this.options.label).appendTo(p.empty()).text(),m=this.options.icons,l=m.primary&&m.secondary,o=[];if(m.primary||m.secondary){if(this.options.text){o.push("ui-button-text-icon"+(l?"s":(m.primary?"-primary":"-secondary")))}if(m.primary){p.prepend("<span class='ui-button-icon-primary ui-icon "+m.primary+"'></span>")}if(m.secondary){p.append("<span class='ui-button-icon-secondary ui-icon "+m.secondary+"'></span>")}if(!this.options.text){o.push(l?"ui-button-icons-only":"ui-button-icon-only");if(!this.hasTitle){p.attr("title",f.trim(n))}}}else{o.push("ui-button-text-only")}p.addClass(o.join(" "))}});f.widget("ui.buttonset",{version:"1.10.3",options:{items:"button, input[type=button], input[type=submit], input[type=reset], input[type=checkbox], input[type=radio], a, :data(ui-button)"},_create:function(){this.element.addClass("ui-buttonset")},_init:function(){this.refresh()},_setOption:function(l,m){if(l==="disabled"){this.buttons.button("option",l,m)}this._super(l,m)},refresh:function(){var l=this.element.css("direction")==="rtl";this.buttons=this.element.find(this.options.items).filter(":ui-button").button("refresh").end().not(":ui-button").button().end().map(function(){return f(this).button("widget")[0]}).removeClass("ui-corner-all ui-corner-left ui-corner-right").filter(":first").addClass(l?"ui-corner-right":"ui-corner-left").end().filter(":last").addClass(l?"ui-corner-left":"ui-corner-right").end().end()},_destroy:function(){this.element.removeClass("ui-buttonset");this.buttons.map(function(){return f(this).button("widget")[0]}).removeClass("ui-corner-left ui-corner-right").end().button("destroy")}})}(jQuery));(function(b,c){var a=5;b.widget("ui.slider",b.ui.mouse,{version:"1.10.3",widgetEventPrefix:"slide",options:{animate:false,distance:0,max:100,min:0,orientation:"horizontal",range:false,step:1,value:0,values:null,change:null,slide:null,start:null,stop:null},_create:function(){this._keySliding=false;this._mouseSliding=false;this._animateOff=true;this._handleIndex=null;this._detectOrientation();this._mouseInit();this.element.addClass("ui-slider ui-slider-"+this.orientation+" ui-widget ui-widget-content ui-corner-all");this._refresh();this._setOption("disabled",this.options.disabled);this._animateOff=false},_refresh:function(){this._createRange();this._createHandles();this._setupEvents();this._refreshValue()},_createHandles:function(){var g,d,e=this.options,j=this.element.find(".ui-slider-handle").addClass("ui-state-default ui-corner-all"),h="<a class='ui-slider-handle ui-state-default ui-corner-all' href='#'></a>",f=[];d=(e.values&&e.values.length)||1;if(j.length>d){j.slice(d).remove();j=j.slice(0,d)}for(g=j.length;g<d;g++){f.push(h)}this.handles=j.add(b(f.join("")).appendTo(this.element));
this.handle=this.handles.eq(0);this.handles.each(function(k){b(this).data("ui-slider-handle-index",k)})},_createRange:function(){var d=this.options,e="";if(d.range){if(d.range===true){if(!d.values){d.values=[this._valueMin(),this._valueMin()]}else{if(d.values.length&&d.values.length!==2){d.values=[d.values[0],d.values[0]]}else{if(b.isArray(d.values)){d.values=d.values.slice(0)}}}}if(!this.range||!this.range.length){this.range=b("<div></div>").appendTo(this.element);e="ui-slider-range ui-widget-header ui-corner-all"}else{this.range.removeClass("ui-slider-range-min ui-slider-range-max").css({left:"",bottom:""})}this.range.addClass(e+((d.range==="min"||d.range==="max")?" ui-slider-range-"+d.range:""))}else{this.range=b([])}},_setupEvents:function(){var d=this.handles.add(this.range).filter("a");this._off(d);this._on(d,this._handleEvents);this._hoverable(d);this._focusable(d)},_destroy:function(){this.handles.remove();this.range.remove();this.element.removeClass("ui-slider ui-slider-horizontal ui-slider-vertical ui-widget ui-widget-content ui-corner-all");this._mouseDestroy()},_mouseCapture:function(f){var j,m,e,h,l,n,i,d,k=this,g=this.options;if(g.disabled){return false}this.elementSize={width:this.element.outerWidth(),height:this.element.outerHeight()};this.elementOffset=this.element.offset();j={x:f.pageX,y:f.pageY};m=this._normValueFromMouse(j);e=this._valueMax()-this._valueMin()+1;this.handles.each(function(o){var p=Math.abs(m-k.values(o));if((e>p)||(e===p&&(o===k._lastChangedValue||k.values(o)===g.min))){e=p;h=b(this);l=o}});n=this._start(f,l);if(n===false){return false}this._mouseSliding=true;this._handleIndex=l;h.addClass("ui-state-active").focus();i=h.offset();d=!b(f.target).parents().addBack().is(".ui-slider-handle");this._clickOffset=d?{left:0,top:0}:{left:f.pageX-i.left-(h.width()/2),top:f.pageY-i.top-(h.height()/2)-(parseInt(h.css("borderTopWidth"),10)||0)-(parseInt(h.css("borderBottomWidth"),10)||0)+(parseInt(h.css("marginTop"),10)||0)};if(!this.handles.hasClass("ui-state-hover")){this._slide(f,l,m)}this._animateOff=true;return true},_mouseStart:function(){return true},_mouseDrag:function(f){var d={x:f.pageX,y:f.pageY},e=this._normValueFromMouse(d);this._slide(f,this._handleIndex,e);return false},_mouseStop:function(d){this.handles.removeClass("ui-state-active");this._mouseSliding=false;this._stop(d,this._handleIndex);this._change(d,this._handleIndex);this._handleIndex=null;this._clickOffset=null;this._animateOff=false;return false},_detectOrientation:function(){this.orientation=(this.options.orientation==="vertical")?"vertical":"horizontal"},_normValueFromMouse:function(e){var d,h,g,f,i;if(this.orientation==="horizontal"){d=this.elementSize.width;h=e.x-this.elementOffset.left-(this._clickOffset?this._clickOffset.left:0)}else{d=this.elementSize.height;h=e.y-this.elementOffset.top-(this._clickOffset?this._clickOffset.top:0)}g=(h/d);if(g>1){g=1}if(g<0){g=0}if(this.orientation==="vertical"){g=1-g}f=this._valueMax()-this._valueMin();i=this._valueMin()+g*f;return this._trimAlignValue(i)},_start:function(f,e){var d={handle:this.handles[e],value:this.value()};if(this.options.values&&this.options.values.length){d.value=this.values(e);d.values=this.values()}return this._trigger("start",f,d)},_slide:function(h,g,f){var d,e,i;if(this.options.values&&this.options.values.length){d=this.values(g?0:1);if((this.options.values.length===2&&this.options.range===true)&&((g===0&&f>d)||(g===1&&f<d))){f=d}if(f!==this.values(g)){e=this.values();e[g]=f;i=this._trigger("slide",h,{handle:this.handles[g],value:f,values:e});d=this.values(g?0:1);if(i!==false){this.values(g,f,true)}}}else{if(f!==this.value()){i=this._trigger("slide",h,{handle:this.handles[g],value:f});if(i!==false){this.value(f)}}}},_stop:function(f,e){var d={handle:this.handles[e],value:this.value()};if(this.options.values&&this.options.values.length){d.value=this.values(e);d.values=this.values()}this._trigger("stop",f,d)},_change:function(f,e){if(!this._keySliding&&!this._mouseSliding){var d={handle:this.handles[e],value:this.value()};
if(this.options.values&&this.options.values.length){d.value=this.values(e);d.values=this.values()}this._lastChangedValue=e;this._trigger("change",f,d)}},value:function(d){if(arguments.length){this.options.value=this._trimAlignValue(d);this._refreshValue();this._change(null,0);return}return this._value()},values:function(e,h){var g,d,f;if(arguments.length>1){this.options.values[e]=this._trimAlignValue(h);this._refreshValue();this._change(null,e);return}if(arguments.length){if(b.isArray(arguments[0])){g=this.options.values;d=arguments[0];for(f=0;f<g.length;f+=1){g[f]=this._trimAlignValue(d[f]);this._change(null,f)}this._refreshValue()}else{if(this.options.values&&this.options.values.length){return this._values(e)}else{return this.value()}}}else{return this._values()}},_setOption:function(e,f){var d,g=0;if(e==="range"&&this.options.range===true){if(f==="min"){this.options.value=this._values(0);this.options.values=null}else{if(f==="max"){this.options.value=this._values(this.options.values.length-1);this.options.values=null}}}if(b.isArray(this.options.values)){g=this.options.values.length}b.Widget.prototype._setOption.apply(this,arguments);switch(e){case"orientation":this._detectOrientation();this.element.removeClass("ui-slider-horizontal ui-slider-vertical").addClass("ui-slider-"+this.orientation);this._refreshValue();break;case"value":this._animateOff=true;this._refreshValue();this._change(null,0);this._animateOff=false;break;case"values":this._animateOff=true;this._refreshValue();for(d=0;d<g;d+=1){this._change(null,d)}this._animateOff=false;break;case"min":case"max":this._animateOff=true;this._refreshValue();this._animateOff=false;break;case"range":this._animateOff=true;this._refresh();this._animateOff=false;break}},_value:function(){var d=this.options.value;d=this._trimAlignValue(d);return d},_values:function(d){var g,f,e;if(arguments.length){g=this.options.values[d];g=this._trimAlignValue(g);return g}else{if(this.options.values&&this.options.values.length){f=this.options.values.slice();for(e=0;e<f.length;e+=1){f[e]=this._trimAlignValue(f[e])}return f}else{return[]}}},_trimAlignValue:function(g){if(g<=this._valueMin()){return this._valueMin()}if(g>=this._valueMax()){return this._valueMax()}var d=(this.options.step>0)?this.options.step:1,f=(g-this._valueMin())%d,e=g-f;if(Math.abs(f)*2>=d){e+=(f>0)?d:(-d)}return parseFloat(e.toFixed(5))},_valueMin:function(){return this.options.min},_valueMax:function(){return this.options.max},_refreshValue:function(){var i,h,l,j,m,g=this.options.range,f=this.options,k=this,e=(!this._animateOff)?f.animate:false,d={};if(this.options.values&&this.options.values.length){this.handles.each(function(n){h=(k.values(n)-k._valueMin())/(k._valueMax()-k._valueMin())*100;d[k.orientation==="horizontal"?"left":"bottom"]=h+"%";b(this).stop(1,1)[e?"animate":"css"](d,f.animate);if(k.options.range===true){if(k.orientation==="horizontal"){if(n===0){k.range.stop(1,1)[e?"animate":"css"]({left:h+"%"},f.animate)}if(n===1){k.range[e?"animate":"css"]({width:(h-i)+"%"},{queue:false,duration:f.animate})}}else{if(n===0){k.range.stop(1,1)[e?"animate":"css"]({bottom:(h)+"%"},f.animate)}if(n===1){k.range[e?"animate":"css"]({height:(h-i)+"%"},{queue:false,duration:f.animate})}}}i=h})}else{l=this.value();j=this._valueMin();m=this._valueMax();h=(m!==j)?(l-j)/(m-j)*100:0;d[this.orientation==="horizontal"?"left":"bottom"]=h+"%";this.handle.stop(1,1)[e?"animate":"css"](d,f.animate);if(g==="min"&&this.orientation==="horizontal"){this.range.stop(1,1)[e?"animate":"css"]({width:h+"%"},f.animate)}if(g==="max"&&this.orientation==="horizontal"){this.range[e?"animate":"css"]({width:(100-h)+"%"},{queue:false,duration:f.animate})}if(g==="min"&&this.orientation==="vertical"){this.range.stop(1,1)[e?"animate":"css"]({height:h+"%"},f.animate)}if(g==="max"&&this.orientation==="vertical"){this.range[e?"animate":"css"]({height:(100-h)+"%"},{queue:false,duration:f.animate})}}},_handleEvents:{keydown:function(h){var i,f,e,g,d=b(h.target).data("ui-slider-handle-index");
switch(h.keyCode){case b.ui.keyCode.HOME:case b.ui.keyCode.END:case b.ui.keyCode.PAGE_UP:case b.ui.keyCode.PAGE_DOWN:case b.ui.keyCode.UP:case b.ui.keyCode.RIGHT:case b.ui.keyCode.DOWN:case b.ui.keyCode.LEFT:h.preventDefault();if(!this._keySliding){this._keySliding=true;b(h.target).addClass("ui-state-active");i=this._start(h,d);if(i===false){return}}break}g=this.options.step;if(this.options.values&&this.options.values.length){f=e=this.values(d)}else{f=e=this.value()}switch(h.keyCode){case b.ui.keyCode.HOME:e=this._valueMin();break;case b.ui.keyCode.END:e=this._valueMax();break;case b.ui.keyCode.PAGE_UP:e=this._trimAlignValue(f+((this._valueMax()-this._valueMin())/a));break;case b.ui.keyCode.PAGE_DOWN:e=this._trimAlignValue(f-((this._valueMax()-this._valueMin())/a));break;case b.ui.keyCode.UP:case b.ui.keyCode.RIGHT:if(f===this._valueMax()){return}e=this._trimAlignValue(f+g);break;case b.ui.keyCode.DOWN:case b.ui.keyCode.LEFT:if(f===this._valueMin()){return}e=this._trimAlignValue(f-g);break}this._slide(h,d,e)},click:function(d){d.preventDefault()},keyup:function(e){var d=b(e.target).data("ui-slider-handle-index");if(this._keySliding){this._keySliding=false;this._stop(e,d);this._change(e,d);b(e.target).removeClass("ui-state-active")}}}})}(jQuery));(function(a,c){var b="ui-effects-";a.effects={effect:{}};
/*!
...
})(jQuery);(function(){var e=["add","remove","toggle"],f={border:1,borderBottom:1,borderColor:1,borderLeft:1,borderRight:1,borderTop:1,borderWidth:1,margin:1,padding:1};a.each(["borderLeftStyle","borderRightStyle","borderBottomStyle","borderTopStyle"],function(h,i){a.fx.step[i]=function(j){if(j.end!=="none"&&!j.setAttr||j.pos===1&&!j.setAttr){jQuery.style(j.elem,i,j.end);j.setAttr=true}}});function g(l){var i,h,j=l.ownerDocument.defaultView?l.ownerDocument.defaultView.getComputedStyle(l,null):l.currentStyle,k={};if(j&&j.length&&j[0]&&j[j[0]]){h=j.length;while(h--){i=j[h];if(typeof j[i]==="string"){k[a.camelCase(i)]=j[i]}}}else{for(i in j){if(typeof j[i]==="string"){k[i]=j[i]}}}return k}function d(h,j){var l={},i,k;for(i in j){k=j[i];if(h[i]!==k){if(!f[i]){if(a.fx.step[i]||!isNaN(parseFloat(k))){l[i]=k}}}}return l}if(!a.fn.addBack){a.fn.addBack=function(h){return this.add(h==null?this.prevObject:this.prevObject.filter(h))}}a.effects.animateClass=function(h,i,l,k){var j=a.speed(i,l,k);return this.queue(function(){var o=a(this),m=o.attr("class")||"",n,p=j.children?o.find("*").addBack():o;p=p.map(function(){var q=a(this);return{el:q,start:g(this)}});n=function(){a.each(e,function(q,r){if(h[r]){o[r+"Class"](h[r])}})};n();p=p.map(function(){this.end=g(this.el[0]);this.diff=d(this.start,this.end);return this});o.attr("class",m);p=p.map(function(){var s=this,q=a.Deferred(),r=a.extend({},j,{queue:false,complete:function(){q.resolve(s)}});this.el.animate(this.diff,r);return q.promise()});a.when.apply(a,p.get()).done(function(){n();a.each(arguments,function(){var q=this.el;a.each(this.diff,function(r){q.css(r,"")})});j.complete.call(o[0])})})};a.fn.extend({addClass:(function(h){return function(j,i,l,k){return i?a.effects.animateClass.call(this,{add:j},i,l,k):h.apply(this,arguments)}})(a.fn.addClass),removeClass:(function(h){return function(j,i,l,k){return arguments.length>1?a.effects.animateClass.call(this,{remove:j},i,l,k):h.apply(this,arguments)}})(a.fn.removeClass),toggleClass:(function(h){return function(k,j,i,m,l){if(typeof j==="boolean"||j===c){if(!i){return h.apply(this,arguments)}else{return a.effects.animateClass.call(this,(j?{add:k}:{remove:k}),i,m,l)}}else{return a.effects.animateClass.call(this,{toggle:k},j,i,m)}}})(a.fn.toggleClass),switchClass:function(h,j,i,l,k){return a.effects.animateClass.call(this,{add:j,remove:h},i,l,k)}})})();(function(){a.extend(a.effects,{version:"1.10.3",save:function(g,h){for(var f=0;f<h.length;f++){if(h[f]!==null){g.data(b+h[f],g[0].style[h[f]])}}},restore:function(g,j){var h,f;for(f=0;f<j.length;f++){if(j[f]!==null){h=g.data(b+j[f]);if(h===c){h=""}g.css(j[f],h)}}},setMode:function(f,g){if(g==="toggle"){g=f.is(":hidden")?"show":"hide"}return g},getBaseline:function(g,h){var i,f;switch(g[0]){case"top":i=0;break;case"middle":i=0.5;break;case"bottom":i=1;break;default:i=g[0]/h.height}switch(g[1]){case"left":f=0;break;case"center":f=0.5;break;case"right":f=1;break;default:f=g[1]/h.width}return{x:f,y:i}},createWrapper:function(g){if(g.parent().is(".ui-effects-wrapper")){return g.parent()}var h={width:g.outerWidth(true),height:g.outerHeight(true),"float":g.css("float")},k=a("<div></div>").addClass("ui-effects-wrapper").css({fontSize:"100%",background:"transparent",border:"none",margin:0,padding:0}),f={width:g.width(),height:g.height()},j=document.activeElement;try{j.id}catch(i){j=document.body}g.wrap(k);if(g[0]===j||a.contains(g[0],j)){a(j).focus()}k=g.parent();if(g.css("position")==="static"){k.css({position:"relative"});g.css({position:"relative"})}else{a.extend(h,{position:g.css("position"),zIndex:g.css("z-index")});a.each(["top","left","bottom","right"],function(l,m){h[m]=g.css(m);if(isNaN(parseInt(h[m],10))){h[m]="auto"}});g.css({position:"relative",top:0,left:0,right:"auto",bottom:"auto"})}g.css(f);return k.css(h).show()},removeWrapper:function(f){var g=document.activeElement;if(f.parent().is(".ui-effects-wrapper")){f.parent().replaceWith(f);if(f[0]===g||a.contains(f[0],g)){a(g).focus()}}return f
},setTransition:function(g,i,f,h){h=h||{};a.each(i,function(k,j){var l=g.cssUnit(j);if(l[0]>0){h[j]=l[0]*f+l[1]}});return h}});function d(g,f,h,i){if(a.isPlainObject(g)){f=g;g=g.effect}g={effect:g};if(f==null){f={}}if(a.isFunction(f)){i=f;h=null;f={}}if(typeof f==="number"||a.fx.speeds[f]){i=h;h=f;f={}}if(a.isFunction(h)){i=h;h=null}if(f){a.extend(g,f)}h=h||f.duration;g.duration=a.fx.off?0:typeof h==="number"?h:h in a.fx.speeds?a.fx.speeds[h]:a.fx.speeds._default;g.complete=i||f.complete;return g}function e(f){if(!f||typeof f==="number"||a.fx.speeds[f]){return true}if(typeof f==="string"&&!a.effects.effect[f]){return true}if(a.isFunction(f)){return true}if(typeof f==="object"&&!f.effect){return true}return false}a.fn.extend({effect:function(){var h=d.apply(this,arguments),j=h.mode,f=h.queue,g=a.effects.effect[h.effect];if(a.fx.off||!g){if(j){return this[j](h.duration,h.complete)}else{return this.each(function(){if(h.complete){h.complete.call(this)}})}}function i(m){var n=a(this),l=h.complete,o=h.mode;function k(){if(a.isFunction(l)){l.call(n[0])}if(a.isFunction(m)){m()}}if(n.is(":hidden")?o==="hide":o==="show"){n[o]();k()}else{g.call(n[0],h,k)}}return f===false?this.each(i):this.queue(f||"fx",i)},show:(function(f){return function(h){if(e(h)){return f.apply(this,arguments)}else{var g=d.apply(this,arguments);g.mode="show";return this.effect.call(this,g)}}})(a.fn.show),hide:(function(f){return function(h){if(e(h)){return f.apply(this,arguments)}else{var g=d.apply(this,arguments);g.mode="hide";return this.effect.call(this,g)}}})(a.fn.hide),toggle:(function(f){return function(h){if(e(h)||typeof h==="boolean"){return f.apply(this,arguments)}else{var g=d.apply(this,arguments);g.mode="toggle";return this.effect.call(this,g)}}})(a.fn.toggle),cssUnit:function(f){var g=this.css(f),h=[];a.each(["em","px","%","pt"],function(j,k){if(g.indexOf(k)>0){h=[parseFloat(g),k]}});return h}})})();(function(){var d={};a.each(["Quad","Cubic","Quart","Quint","Expo"],function(f,e){d[e]=function(g){return Math.pow(g,f+2)}});a.extend(d,{Sine:function(e){return 1-Math.cos(e*Math.PI/2)},Circ:function(e){return 1-Math.sqrt(1-e*e)},Elastic:function(e){return e===0||e===1?e:-Math.pow(2,8*(e-1))*Math.sin(((e-1)*80-7.5)*Math.PI/15)},Back:function(e){return e*e*(3*e-2)},Bounce:function(g){var e,f=4;while(g<((e=Math.pow(2,--f))-1)/11){}return 1/Math.pow(4,3-f)-7.5625*Math.pow((e*3-2)/22-g,2)}});a.each(d,function(f,e){a.easing["easeIn"+f]=e;a.easing["easeOut"+f]=function(g){return 1-e(1-g)};a.easing["easeInOut"+f]=function(g){return g<0.5?e(g*2)/2:1-e(g*-2+2)/2}})})()})(jQuery);(function(a,b){a.effects.effect.slide=function(e,i){var f=a(this),k=["position","top","bottom","left","right","width","height"],j=a.effects.setMode(f,e.mode||"show"),m=j==="show",l=e.direction||"left",g=(l==="up"||l==="down")?"top":"left",d=(l==="up"||l==="left"),c,h={};a.effects.save(f,k);f.show();c=e.distance||f[g==="top"?"outerHeight":"outerWidth"](true);a.effects.createWrapper(f).css({overflow:"hidden"});if(m){f.css(g,d?(isNaN(c)?"-"+c:-c):c)}h[g]=(m?(d?"+=":"-="):(d?"-=":"+="))+c;f.animate(h,{queue:false,duration:e.duration,easing:e.easing,complete:function(){if(j==="hide"){f.hide()}a.effects.restore(f,k);a.effects.removeWrapper(f);i()}})}})(jQuery);(function(b,a){function f(h){function i(l,k){var m;a!==l&&(l=parseFloat(l));if(a===k){m=k=255}else{if(1===k){if(a===l||1===l){return 1}k=100;m=1}else{m=k}}return isNaN(l)||l<=0?0:k<l?m:l<1||1===k?1===m?l:l*m|0:l*m/k}function e(l,k,n){function m(p,o,q){q=++q%1;return 6*q<1?p+(o-p)*6*q:2*q<1?o:3*q<2?p+(o-p)*(4-6*q):p}l=i(l,360)/360;k=i(k,1);n=i(n,1);if(0===k){return n=Math.round(255*n),[n,n,n]}k=n<0.5?n+n*k:n+k-n*k;n=n+n-k;return[Math.round(255*m(n,k,l+1/3)),Math.round(255*m(n,k,l)),Math.round(255*m(n,k,l-1/3))]}function j(n,l,q){var n=i(n,360)/60,l=i(l,1),q=i(q,1),p=n|0,k=n-p,n=Math.round(255*q*(1-l)),o=Math.round(255*q*(1-l*k)),l=Math.round(255*q*(1-l*(1-k))),q=Math.round(255*q);switch(p){case 1:return[o,q,n];case 2:return[n,q,l];case 3:return[n,o,q];
case 4:return[l,n,q];case 5:return[q,n,o]}return[q,l,n]}this.setColor=function(k){this.c=true;if("number"===typeof k){this.a=(k>>24&255)/255,this.r=k>>16&255,this.g=k>>8&255,this.b=k&255}else{for(;"object"===typeof k;){if(0 in k&&1 in k&&2 in k){this.a=i(k[3],1);this.r=i(k[0]);this.g=i(k[1]);this.b=i(k[2]);return}else{if("r" in k&&"g" in k&&"b" in k){this.a=i(k.a,1);this.r=i(k.r);this.g=i(k.g);this.b=i(k.b);return}else{if("h" in k&&"s" in k){var l;if("l" in k){l=e(k.h,k.s,k.l)}else{if("v" in k){l=j(k.h,k.s,k.v)}else{if("b" in k){l=j(k.h,k.s,k.b)}else{break}}}this.a=i(k.a,1);this.r=l[0];this.g=l[1];this.b=l[2];return}}}break}if("string"===typeof k){k=k.toLowerCase().replace(/[^a-z0-9,.()#%]/g,"");if("transparent"===k){this.a=this.r=this.g=this.b=0;return}if("rand"===k){k=Math.random()*16777215|0;this.a=1;this.r=k>>16&255;this.g=k>>8&255;this.b=k&255;return}a!==g[k]&&(k="#"+g[k]);if(l=/^#?([0-9a-f]{2})([0-9a-f]{2})([0-9a-f]{2})$/.exec(k)){this.a=1;this.r=parseInt(l[1],16);this.g=parseInt(l[2],16);this.b=parseInt(l[3],16);return}if(l=/^#?([0-9a-f])([0-9a-f])([0-9a-f])$/.exec(k)){this.a=1;this.r=parseInt(l[1]+l[1],16);this.g=parseInt(l[2]+l[2],16);this.b=parseInt(l[3]+l[3],16);return}if(l=/^rgba?\((\d{1,3}),(\d{1,3}),(\d{1,3})(,([0-9.]+))?\)$/.exec(k)){this.a=i(l[5],1);this.r=i(l[1]);this.g=i(l[2]);this.b=i(l[3]);return}if(l=/^rgba?\(([0-9.]+\%),([0-9.]+\%),([0-9.]+\%)(,([0-9.]+)\%?)?\)$/.exec(k)){this.a=i(l[5],1);this.r=Math.round(2.55*i(l[1],100));this.g=Math.round(2.55*i(l[2],100));this.b=Math.round(2.55*i(l[3],100));return}if(l=/^hs([bvl])a?\((\d{1,3}),(\d{1,3}),(\d{1,3})(,([0-9.]+))?\)$/.exec(k)){k=("l"===l[1]?e:j)(parseInt(l[2],10),parseInt(l[3],10),parseInt(l[4],10));this.a=i(l[6],1);this.r=k[0];this.g=k[1];this.b=k[2];return}if(l=/^(\d{1,3}),(\d{1,3}),(\d{1,3})(,([0-9.]+))?$/.exec(k)){this.a=i(l[5],1);this.r=i(l[1]);this.g=i(l[2]);this.b=i(l[3]);return}}this.c=false}};this.getColor=function(k){if(a!==k){switch(k.toLowerCase()){case"rgb":return this.getRGB();case"hsv":case"hsb":return this.getHSV();case"hsl":return this.getHSL();case"int":return this.getInt();case"array":return this.getArray();case"fraction":return this.getFraction();case"css":case"style":return this.getCSS();case"name":return this.getName()}}return this.getHex()};this.getRGB=function(){return this.c?{r:this.r,g:this.g,b:this.b,a:this.a}:null};this.getCSS=function(){return this.c?0===this.a?"transparent":1===this.a?"rgb("+this.r+","+this.g+","+this.b+")":d(this.r,this.g,this.b,this.a):null};this.getArray=function(){return this.c?[this.r,this.g,this.b,100*this.a|0]:null};this.getName=function(){if(this.c){var n=null,l,p=g,q=this.getHSL(),k;for(k in p){var o=(new f(p[k])).getHSL(),o=Math.sqrt(0.5*(q.h-o.h)*(q.h-o.h)+0.5*(q.s-o.s)*(q.s-o.s)+(q.l-o.l)*(q.l-o.l));if(null===n||o<n){n=o,l=k}}return l}return null};this.getFraction=function(){return this.c?{r:this.r/255,g:this.g/255,b:this.b/255,a:this.a}:null};this.getHSL=function(){if(this.c){var l=this.r/255,k=this.g/255,p=this.b/255,q=Math.min(l,k,p),o=Math.max(l,k,p),m=o-q,n=(o+q)/2;0===m?q=l=0:(l=l===o?(k-p)/m:k===o?2+(p-l)/m:4+(l-k)/m,q=m/(n<0.5?o+q:2-o-q));return{h:Math.round(60*((6+l)%6)),s:Math.round(100*q),l:Math.round(100*n),a:this.a}}return null};this.getHSV=function(){if(this.c){var l=this.r/255,k=this.g/255,n=this.b/255,o=Math.min(l,k,n),m=Math.max(l,k,n),o=m-o;return{h:Math.round(60*((6+(0===o?0:l===m?(k-n)/o:k===m?2+(n-l)/o:4+(l-k)/o))%6)),s:Math.round(100*(0===m?0:o/m)),v:Math.round(100*m),a:this.a}}return null};this.getHex=function(){if(this.c){var l=this.r>>4,k=this.g>>4,p=this.b>>4,o=this.r&15,n=this.g&15,m=this.b&15;return 0===(l^o|k^n|p^m)?"#"+"0123456789abcdef".charAt(l)+"0123456789abcdef".charAt(k)+"0123456789abcdef".charAt(p):"#"+"0123456789abcdef".charAt(l)+"0123456789abcdef".charAt(o)+"0123456789abcdef".charAt(k)+"0123456789abcdef".charAt(n)+"0123456789abcdef".charAt(p)+"0123456789abcdef".charAt(m)}return null};this.getInt=function(k){return this.c?a!==k?(100*this.a|0)<<24^this.r<<16^this.g<<8^this.b:(this.r<<16^this.g<<8^this.b)&16777215:null
};this.toString=function(){return this.getHex()};this.setColor(h)}function c(h,i){var e="";do{if(e=b.curCSS(h,i),""!==e&&"transparent"!==e&&"rgba(0, 0, 0, 0)"!==e||b.nodeName(h,"body")){break}}while(h=h.parentNode);""===e&&(e=b.support.rgba?"transparent":"backgroundColor"===i?"white":"black");return new f(e)}var g={aliceblue:"f0f8ff",antiquewhite:"faebd7",aqua:"0ff",aquamarine:"7fffd4",azure:"f0ffff",beige:"f5f5dc",bisque:"ffe4c4",black:"000",blanchedalmond:"ffebcd",blue:"00f",blueviolet:"8a2be2",brown:"a52a2a",burlywood:"deb887",burntsienna:"ea7e5d",cadetblue:"5f9ea0",chartreuse:"7fff00",chocolate:"d2691e",coral:"ff7f50",cornflowerblue:"6495ed",cornsilk:"fff8dc",crimson:"dc143c",cyan:"0ff",darkblue:"00008b",darkcyan:"008b8b",darkgoldenrod:"b8860b",darkgray:"a9a9a9",darkgreen:"006400",darkgrey:"a9a9a9",darkkhaki:"bdb76b",darkmagenta:"8b008b",darkolivegreen:"556b2f",darkorange:"ff8c00",darkorchid:"9932cc",darkred:"8b0000",darksalmon:"e9967a",darkseagreen:"8fbc8f",darkslateblue:"483d8b",darkslategray:"2f4f4f",darkslategrey:"2f4f4f",darkturquoise:"00ced1",darkviolet:"9400d3",deeppink:"ff1493",deepskyblue:"00bfff",dimgray:"696969",dimgrey:"696969",dodgerblue:"1e90ff",firebrick:"b22222",floralwhite:"fffaf0",forestgreen:"228b22",fuchsia:"f0f",gainsboro:"dcdcdc",ghostwhite:"f8f8ff",gold:"ffd700",goldenrod:"daa520",gray:"808080",green:"008000",greenyellow:"adff2f",grey:"808080",honeydew:"f0fff0",hotpink:"ff69b4",indianred:"cd5c5c",indigo:"4b0082",ivory:"fffff0",khaki:"f0e68c",lavender:"e6e6fa",lavenderblush:"fff0f5",lawngreen:"7cfc00",lemonchiffon:"fffacd",lightblue:"add8e6",lightcoral:"f08080",lightcyan:"e0ffff",lightgoldenrodyellow:"fafad2",lightgray:"d3d3d3",lightgreen:"90ee90",lightgrey:"d3d3d3",lightpink:"ffb6c1",lightsalmon:"ffa07a",lightseagreen:"20b2aa",lightskyblue:"87cefa",lightslategray:"789",lightslategrey:"789",lightsteelblue:"b0c4de",lightyellow:"ffffe0",lime:"0f0",limegreen:"32cd32",linen:"faf0e6",magenta:"f0f",maroon:"800000",mediumaquamarine:"66cdaa",mediumblue:"0000cd",mediumorchid:"ba55d3",mediumpurple:"9370db",mediumseagreen:"3cb371",mediumslateblue:"7b68ee",mediumspringgreen:"00fa9a",mediumturquoise:"48d1cc",mediumvioletred:"c71585",midnightblue:"191970",mintcream:"f5fffa",mistyrose:"ffe4e1",moccasin:"ffe4b5",navajowhite:"ffdead",navy:"000080",oldlace:"fdf5e6",olive:"808000",olivedrab:"6b8e23",orange:"ffa500",orangered:"ff4500",orchid:"da70d6",palegoldenrod:"eee8aa",palegreen:"98fb98",paleturquoise:"afeeee",palevioletred:"db7093",papayawhip:"ffefd5",peachpuff:"ffdab9",peru:"cd853f",pink:"ffc0cb",plum:"dda0dd",powderblue:"b0e0e6",purple:"800080",red:"f00",rosybrown:"bc8f8f",royalblue:"4169e1",saddlebrown:"8b4513",salmon:"fa8072",sandybrown:"f4a460",seagreen:"2e8b57",seashell:"fff5ee",sienna:"a0522d",silver:"c0c0c0",skyblue:"87ceeb",slateblue:"6a5acd",slategray:"708090",slategrey:"708090",snow:"fffafa",springgreen:"00ff7f",steelblue:"4682b4",tan:"d2b48c",teal:"008080",thistle:"d8bfd8",tomato:"ff6347",turquoise:"40e0d0",violet:"ee82ee",wheat:"f5deb3",white:"fff",whitesmoke:"f5f5f5",yellow:"ff0",yellowgreen:"9acd32"},d;b.each("color,backgroundColor,borderColor,borderTopColor,borderBottomColor,borderLeftColor,borderRightColor,outlineColor".split(","),function(e,h){b.cssHooks[h]={set:function(i,j){i.style[h]=(new f(j)).getCSS()}};b.fx.step[h]=function(j){if(a===j.xinit){if("string"===typeof j.end&&-1!==j.end.indexOf(";")){var n,l=j.end.split(";");if(l.length>2){for(n in l){l[n]=-1===l[n].indexOf("native")?new f(l[n]):c(j.elem,h)}j.start=null;j.end=l}else{j.start=new f(l[0]),j.end=new f(l[1])}}else{j.start=c(j.elem,h),j.end=new f(j.end)}j.xinit=1}n=j.start;var l=j.end,m=j.pos;if(null===n){var k=m*(l.length-1),m=m<1?k|0:l.length-2;n=l[m];l=l[m+1];m=k-m}j.elem.style[h]=d(n.r+m*(l.r-n.r)|0,n.g+m*(l.g-n.g)|0,n.b+m*(l.b-n.b)|0,n.a+m*(l.a-n.a))}});b(function(){var e=document.createElement("div").style;d=function(i,h,k,j){return"rgba("+i+","+h+","+k+","+j+")"};e.cssText="background-color:rgba(1,1,1,.5)";if(!(b.support.rgba=e.backgroundColor.indexOf("rgba")>-1)){d=function(i,h,j){return"rgb("+i+","+h+","+j+")"
}}});b.xcolor=new function(){this.test=function(e){e=new f(e);return e.c?e:null};this.red=function(e){e=new f(e);return e.c?(e.g=255,e.b=255,e):null};this.blue=function(e){e=new f(e);return e.c?(e.r=255,e.g=255,e):null};this.green=function(e){e=new f(e);return e.c?(e.r=255,e.b=255,e):null};this.sepia=function(h){h=new f(h);if(h.c){var i=h.r,e=h.g,j=h.b;h.r=Math.round(i*0.393+e*0.769+j*0.189);h.g=Math.round(i*0.349+e*0.686+j*0.168);h.b=Math.round(i*0.272+e*0.534+j*0.131);return h}return null};this.random=function(){return new f([255*Math.random()|0,255*Math.random()|0,255*Math.random()|0])};this.inverse=function(e){e=new f(e);return e.c?(e.r^=255,e.g^=255,e.b^=255,e):null};this.opacity=function(h,i,e){h=new f(h);i=new f(i);return h.c&i.c?(e>1&&(e/=100),e=Math.max(e-1+i.a,0),h.r=Math.round((i.r-h.r)*e+h.r),h.g=Math.round((i.g-h.g)*e+h.g),h.b=Math.round((i.b-h.b)*e+h.b),h):null};this.greyfilter=function(h,i){var e,j=new f(h);if(j.c){switch(i){case 1:e=0.35+13*(j.r+j.g+j.b)/60;break;case 2:e=(13*(j.r+j.g+j.b)+5355)/60;break;default:e=j.r*0.3+j.g*0.59+j.b*0.11}j.r=j.g=j.b=Math.min(e|0,255);return j}return null};this.webround=function(e){e=new f(e);if(e.c){if((e.r+=51-e.r%51)>255){e.r=255}if((e.g+=51-e.g%51)>255){e.g=255}if((e.b+=51-e.b%51)>255){e.b=255}return e}return null};this.distance=function(h,i){var e=new f(h),j=new f(i);return e.c&j.c?Math.sqrt(3*(j.r-e.r)*(j.r-e.r)+4*(j.g-e.g)*(j.g-e.g)+2*(j.b-e.b)*(j.b-e.b)):null};this.readable=function(h,i,e){i=new f(i);h=new f(h);e=e||10;return i.c&h.c?(h=h.r*0.299+h.g*0.587+h.b*0.114-i.r*0.299-i.g*0.587-i.b*0.114,!(h<1.5+141.162*Math.pow(0.975,e)&&h>-0.5-154.709*Math.pow(0.99,e))):null};this.combine=function(h,i){var e=new f(h),j=new f(i);return e.c&j.c?(e.r^=j.r,e.g^=j.g,e.b^=j.b,e):null};this.breed=function(i,l){var e=new f(i),m=new f(l),j=0,k=6;if(e.c&m.c){for(;k--;){Math.random()<0.5&&(j|=15<<(k<<2))}e.r=e.r&j>>16&255|m.r&(j>>16&255^255);e.g=e.g&j>>8&255|m.g&(j>>8&255^255);e.b=e.b&j>>0&255|m.b&(j>>0&255^255);return e}return null};this.additive=function(h,i){var e=new f(h),j=new f(i);if(e.c&j.c){if((e.r+=j.r)>255){e.r=255}if((e.g+=j.g)>255){e.g=255}if((e.b+=j.b)>255){e.b=255}return e}return null};this.subtractive=function(h,i){var e=new f(h),j=new f(i);if(e.c&j.c){if((e.r+=j.r-255)<0){e.r=0}if((e.g+=j.g-255)<0){e.g=0}if((e.b+=j.b-255)<0){e.b=0}return e}return null};this.subtract=function(h,i){var e=new f(h),j=new f(i);if(e.c&j.c){if((e.r-=j.r)<0){e.r=0}if((e.g-=j.g)<0){e.g=0}if((e.b-=j.b)<0){e.b=0}return e}return null};this.multiply=function(h,i){var e=new f(h),j=new f(i);return e.c&j.c?(e.r=e.r/255*j.r|0,e.g=e.g/255*j.g|0,e.b=e.b/255*j.b|0,e):null};this.average=function(h,i){var e=new f(h),j=new f(i);return e.c&j.c?(e.r=e.r+j.r>>1,e.g=e.g+j.g>>1,e.b=e.b+j.b>>1,e):null};this.triad=function(e){e=new f(e);return e.c?[e,new f([e.b,e.r,e.g]),new f([e.g,e.b,e.r])]:null};this.tetrad=function(e){e=new f(e);return e.c?[e,new f([e.b,e.r,e.b]),new f([e.b,e.g,e.r]),new f([e.r,e.b,e.r])]:null};this.gradientlevel=function(h,i,e,j){a===j&&(j=1);if(e>j){return null}h=new f(h);i=new f(i);return h.c&i.c?(h.r=h.r+(i.r-h.r)/j*e|0,h.g=h.g+(i.g-h.g)/j*e|0,h.b=h.b+(i.b-h.b)/j*e|0,h):null};this.gradientarray=function(h,i,e){if(i>e){return null}var j=i*(h.length-1)/e|0,i=(i-e*j/(h.length-1))/e,e=new f(h[j]),j=new f(h[j+1]);return e.c&j.c?(e.r=e.r+h.length*(j.r-e.r)*i|0,e.g=e.g+h.length*(j.g-e.g)*i|0,e.b=e.b+h.length*(j.b-e.b)*i|0,e):null};this.nearestname=function(e){e=new f(e);return e.c?e.getName():null};this.darken=function(h,i,e){if(a===i){i=1}else{if(i<0){return this.lighten(h,-i,e)}}a===e&&(e=32);h=new f(h);if(h.c){if((h.r-=e*i)<0){h.r=0}if((h.g-=e*i)<0){h.g=0}if((h.b-=e*i)<0){h.b=0}return h}return null};this.lighten=function(h,i,e){if(a===i){i=1}else{if(i<0){return this.darken(h,-i,e)}}a===e&&(e=32);h=new f(h);if(h.c){if((h.r+=e*i)>255){h.r=255}if((h.g+=e*i)>255){h.g=255}if((h.b+=e*i)>255){h.b=255}return h}return null};this.analogous=function(h,i,e){a===i&&(i=8);a===e&&(e=30);var j=new f(h);if(j.c){h=j.getHSV();
e=360/e;j=[j];for(h.h=(h.h-(e*i>>1)+720)%360;--i;){h.h+=e,h.h%=360,j.push(new f(h))}return j}return null};this.complementary=function(e){e=new f(e);return e.c?(e=e.getHSL(),e.h=(e.h+180)%360,new f(e)):null};this.splitcomplement=function(e){var h=new f(e);return h.c?(e=h.getHSV(),h=[h],e.h+=72,e.h%=360,h.push(new f(e)),e.h+=144,e.h%=360,h.push(new f(e)),h):null};this.monochromatic=function(h,i){a===i&&(i=6);var e=new f(h);if(e.c){for(var j=e.getHSV(),e=[e];--i;){j.v+=20,j.v%=100,e.push(new f(j))}return e}return null}};b.fn.readable=function(){var h=this[0],i="",e="";do{if(""===i&&("transparent"===(i=b.curCSS(h,"color"))||"rgba(0, 0, 0, 0)"===i)){i=""}if(""===e&&("transparent"===(e=b.curCSS(h,"backgroundColor"))||"rgba(0, 0, 0, 0)"===e)){e=""}if(""!==i&&""!==e||b.nodeName(h,"body")){break}}while(h=h.parentNode);""===i&&(i="black");""===e&&(e="white");return b.xcolor.readable(e,i)};b.fn.colorize=function(h,i,e){var j={gradient:function(l,k){return l/k},flip:function(l,k,n,m){return" "===m?n:!n},pillow:function(l,k){l*=2;return l<=k?l/k:2-l/k}};if("function"!==typeof e){if(void 0===j[e]){return}else{e=j[e]}}h=new f(h);i=new f(i);this.each(function(){var p=this.childNodes,o=0,n=0;if(h.c&i.c){for(var l=p.length;l--;o+=p[l].textContent.length){}(function m(C){var B=0,A;if(3===C.nodeType){var z=h,v=i,x=o,F,E,y=0,D,w=e;A=C.nodeValue.length;E=document.createElement("span");for(B=0;B<A;++B){F=document.createElement("span"),D=C.nodeValue.charAt(B),y=w(n,x,y,D),F.style.color=d(z.r+y*(v.r-z.r)|0,z.g+y*(v.g-z.g)|0,z.b+y*(v.b-z.b)|0,z.a+y*(v.a-z.a)),F.appendChild(document.createTextNode(D)),E.appendChild(F),++n}C.parentNode.replaceChild(E,C)}else{for(A=C.childNodes.length;B<A;++B){m(C.childNodes[B])}}})(this)}})}})(jQuery);(function($){var settings={},roots={},caches={},_consts={className:{BUTTON:"button",LEVEL:"level",ICO_LOADING:"ico_loading",SWITCH:"switch"},event:{NODECREATED:"ztree_nodeCreated",CLICK:"ztree_click",EXPAND:"ztree_expand",COLLAPSE:"ztree_collapse",ASYNC_SUCCESS:"ztree_async_success",ASYNC_ERROR:"ztree_async_error"},id:{A:"_a",ICON:"_ico",SPAN:"_span",SWITCH:"_switch",UL:"_ul"},line:{ROOT:"root",ROOTS:"roots",CENTER:"center",BOTTOM:"bottom",NOLINE:"noline",LINE:"line"},folder:{OPEN:"open",CLOSE:"close",DOCU:"docu"},node:{CURSELECTED:"curSelectedNode"}},_setting={treeId:"",treeObj:null,view:{addDiyDom:null,autoCancelSelected:true,dblClickExpand:true,expandSpeed:"fast",fontCss:{},nameIsHTML:false,selectedMulti:true,showIcon:true,showLine:true,showTitle:true},data:{key:{children:"children",name:"name",title:"",url:"url"},simpleData:{enable:false,idKey:"id",pIdKey:"pId",rootPId:null},keep:{parent:false,leaf:false}},async:{enable:false,contentType:"application/x-www-form-urlencoded",type:"post",dataType:"text",url:"",autoParam:[],otherParam:[],dataFilter:null},callback:{beforeAsync:null,beforeClick:null,beforeDblClick:null,beforeRightClick:null,beforeMouseDown:null,beforeMouseUp:null,beforeExpand:null,beforeCollapse:null,beforeRemove:null,onAsyncError:null,onAsyncSuccess:null,onNodeCreated:null,onClick:null,onDblClick:null,onRightClick:null,onMouseDown:null,onMouseUp:null,onExpand:null,onCollapse:null,onRemove:null}},_initRoot=function(setting){var r=data.getRoot(setting);if(!r){r={};data.setRoot(setting,r)}r[setting.data.key.children]=[];r.expandTriggerFlag=false;r.curSelectedList=[];r.noSelection=true;r.createdNodes=[];r.zId=0;r._ver=(new Date()).getTime()},_initCache=function(setting){var c=data.getCache(setting);if(!c){c={};data.setCache(setting,c)}c.nodes=[];c.doms=[]},_bindEvent=function(setting){var o=setting.treeObj,c=consts.event;o.bind(c.NODECREATED,function(event,treeId,node){tools.apply(setting.callback.onNodeCreated,[event,treeId,node])});o.bind(c.CLICK,function(event,srcEvent,treeId,node,clickFlag){tools.apply(setting.callback.onClick,[srcEvent,treeId,node,clickFlag])});o.bind(c.EXPAND,function(event,treeId,node){tools.apply(setting.callback.onExpand,[event,treeId,node])});o.bind(c.COLLAPSE,function(event,treeId,node){tools.apply(setting.callback.onCollapse,[event,treeId,node])
...
};a.getMeasuredLineHeight=function(){return 1.2*this._getWorkingContext().measureText("M").width};a.getMeasuredHeight=function(){return this._drawText()*(this.lineHeight||this.getMeasuredLineHeight())};a.clone=function(){var b=new d(this.text,this.font,this.color);this.cloneProps(b);return b};a.toString=function(){return"[Text (text="+(20<this.text.length?this.text.substr(0,17)+"...":this.text)+")]"};a.DisplayObject_cloneProps=a.cloneProps;a.cloneProps=function(b){this.DisplayObject_cloneProps(b);b.textAlign=this.textAlign;b.textBaseline=this.textBaseline;b.maxWidth=this.maxWidth;b.outline=this.outline;b.lineHeight=this.lineHeight;b.lineWidth=this.lineWidth};a._getWorkingContext=function(){var b=d._workingContext;b.font=this.font;b.textAlign=this.textAlign||"start";b.textBaseline=this.textBaseline||"alphabetic";return b};a._drawText=function(v){var u=!!v;u||(v=this._getWorkingContext());for(var t=String(this.text).split(/(?:\r\n|\r|\n)/),s=this.lineHeight||this.getMeasuredLineHeight(),r=0,q=0,p=t.length;q<p;q++){var o=v.measureText(t[q]).width;if(null==this.lineWidth||o<this.lineWidth){u&&this._drawTextLine(v,t[q],r*s)}else{for(var o=t[q].split(/(\s)/),m=o[0],i=1,h=o.length;i<h;i+=2){v.measureText(m+o[i]+o[i+1]).width>this.lineWidth?(u&&this._drawTextLine(v,m,r*s),r++,m=o[i+1]):m+=o[i]+o[i+1]}u&&this._drawTextLine(v,m,r*s)}r++}return r};a._drawTextLine=function(f,e,g){this.outline?f.strokeText(e,0,g,this.maxWidth||65535):f.fillText(e,0,g,this.maxWidth||65535)};createjs.Text=d})();this.createjs=this.createjs||{};(function(){var a=function(){throw"SpriteSheetUtils cannot be instantiated"};a._workingCanvas=createjs.createCanvas?createjs.createCanvas():document.createElement("canvas");a._workingContext=a._workingCanvas.getContext("2d");a.addFlippedFrames=function(e,f,c,g){if(f||c||g){var i=0;f&&a._flip(e,++i,!0,!1);c&&a._flip(e,++i,!1,!0);g&&a._flip(e,++i,!0,!0)}};a.extractFrame=function(e,f){isNaN(f)&&(f=e.getAnimation(f).frames[0]);var c=e.getFrame(f);if(!c){return null}var g=c.rect,i=a._workingCanvas;i.width=g.width;i.height=g.height;a._workingContext.drawImage(c.image,g.x,g.y,g.width,g.height,0,0,g.width,g.height);c=new Image;c.src=i.toDataURL("image/png");return c};a.mergeAlpha=function(d,e,g){g||(g=createjs.createCanvas?createjs.createCanvas():document.createElement("canvas"));g.width=Math.max(e.width,d.width);g.height=Math.max(e.height,d.height);var f=g.getContext("2d");f.save();f.drawImage(d,0,0);f.globalCompositeOperation="destination-in";f.drawImage(e,0,0);f.restore();return g};a._flip=function(y,z,o,t){for(var x=y._images,w=a._workingCanvas,v=a._workingContext,u=x.length/z,s=0;s<u;s++){var r=x[s];r.__tmp=s;w.width=0;w.width=r.width;w.height=r.height;v.setTransform(o?-1:1,0,0,t?-1:1,o?r.width:0,t?r.height:0);v.drawImage(r,0,0);var q=new Image;q.src=w.toDataURL("image/png");q.width=r.width;q.height=r.height;x.push(q)}v=y._frames;w=v.length/z;for(s=0;s<w;s++){var r=v[s],i=r.rect.clone(),q=x[r.image.__tmp+u*z],c={image:q,rect:i,regX:r.regX,regY:r.regY};o&&(i.x=q.width-i.x-i.width,c.regX=i.width-r.regX);t&&(i.y=q.height-i.y-i.height,c.regY=i.height-r.regY);v.push(c)}o="_"+(o?"h":"")+(t?"v":"");t=y._animations;y=y._data;x=t.length/z;for(s=0;s<x;s++){v=t[s];r=y[v];u={name:v+o,frequency:r.frequency,next:r.next,frames:[]};r.next&&(u.next+=o);v=r.frames;r=0;for(q=v.length;r<q;r++){u.frames.push(v[r]+w*z)}y[u.name]=u;t.push(u.name)}};createjs.SpriteSheetUtils=a})();this.createjs=this.createjs||{};(function(){var d=function(){this.initialize()},a=d.prototype;d.ERR_DIMENSIONS="frame dimensions exceed max spritesheet dimensions";d.ERR_RUNNING="a build is already running";a.maxWidth=2048;a.maxHeight=2048;a.spriteSheet=null;a.scale=1;a.padding=1;a.timeSlice=0.3;a.progress=-1;a.onComplete=null;a.onProgress=null;a.addEventListener=null;a.removeEventListener=null;a.removeAllEventListeners=null;a.dispatchEvent=null;a.hasEventListener=null;a._listeners=null;createjs.EventDispatcher.initialize(a);a._frames=null;a._animations=null;a._data=null;
a._nextFrameIndex=0;a._index=0;a._timerID=null;a._scale=1;a.initialize=function(){this._frames=[];this._animations={}};a.addFrame=function(g,c,i,l,k,j){if(this._data){throw d.ERR_RUNNING}c=c||g.bounds||g.nominalBounds;!c&&g.getBounds&&(c=g.getBounds());if(!c){return null}i=i||1;return this._frames.push({source:g,sourceRect:c,scale:i,funct:l,params:k,scope:j,index:this._frames.length,height:c.height*i})-1};a.addAnimation=function(e,c,f,g){if(this._data){throw d.ERR_RUNNING}this._animations[e]={frames:c,next:f,frequency:g}};a.addMovieClip=function(r,q,l){if(this._data){throw d.ERR_RUNNING}var p=r.frameBounds,o=q||r.bounds||r.nominalBounds;!o&&r.getBounds&&(o=r.getBounds());if(!o&&!p){return null}q=this._frames.length;for(var n=r.timeline.duration,m=0;m<n;m++){this.addFrame(r,p&&p[m]?p[m]:o,l,function(f){var e=this.actionsEnabled;this.actionsEnabled=!1;this.gotoAndStop(f);this.actionsEnabled=e},[m],r)}m=r.timeline._labels;r=[];for(var i in m){r.push({index:m[i],label:i})}if(r.length){r.sort(function(f,e){return f.index-e.index});m=0;for(i=r.length;m<i;m++){l=r[m].label;for(var p=q+(m==i-1?n:r[m+1].index),o=[],c=q+r[m].index;c<p;c++){o.push(c)}this.addAnimation(l,o,!0)}}};a.build=function(){if(this._data){throw d.ERR_RUNNING}for(this._startBuild();this._drawNext();){}this._endBuild();return this.spriteSheet};a.buildAsync=function(e){if(this._data){throw d.ERR_RUNNING}this.timeSlice=e;this._startBuild();var c=this;this._timerID=setTimeout(function(){c._run()},50-50*Math.max(0.01,Math.min(0.99,this.timeSlice||0.3)))};a.stopAsync=function(){clearTimeout(this._timerID);this._data=null};a.clone=function(){throw"SpriteSheetBuilder cannot be cloned."};a.toString=function(){return"[SpriteSheetBuilder]"};a._startBuild=function(){var i=this.padding||0;this.progress=0;this.spriteSheet=null;this._index=0;this._scale=this.scale;var c=[];this._data={images:[],frames:c,animations:this._animations};var l=this._frames.slice();l.sort(function(f,e){return f.height<=e.height?-1:1});if(l[l.length-1].height+2*i>this.maxHeight){throw d.ERR_DIMENSIONS}for(var p=0,o=0,n=0;l.length;){var m=this._fillRow(l,p,n,c,i);m.w>o&&(o=m.w);p+=m.h;if(!m.h||!l.length){var k=createjs.createCanvas?createjs.createCanvas():document.createElement("canvas");k.width=this._getSize(o,this.maxWidth);k.height=this._getSize(p,this.maxHeight);this._data.images[n]=k;m.h||(o=p=0,n++)}}};a._getSize=function(f,e){for(var g=4;Math.pow(2,++g)<f;){}return Math.min(e,Math.pow(2,g))};a._fillRow=function(E,D,y,C,B){var A=this.maxWidth,z=this.maxHeight;D+=B;for(var z=z-D,x=B,w=0,v=E.length-1;0<=v;v--){var o=E[v],m=this._scale*o.scale,i=o.sourceRect,H=o.source,c=Math.floor(m*i.x-B),F=Math.floor(m*i.y-B),G=Math.ceil(m*i.height+2*B),i=Math.ceil(m*i.width+2*B);if(i>A){throw d.ERR_DIMENSIONS}G>z||x+i>A||(o.img=y,o.rect=new createjs.Rectangle(x,D,i,G),w=w||G,E.splice(v,1),C[o.index]=[x,D,i,G,y,Math.round(-c+m*H.regX-B),Math.round(-F+m*H.regY-B)],x+=i)}return{w:x,h:w}};a._endBuild=function(){this.spriteSheet=new createjs.SpriteSheet(this._data);this._data=null;this.progress=1;this.onComplete&&this.onComplete(this);this.dispatchEvent("complete")};a._run=function(){for(var f=50*Math.max(0.01,Math.min(0.99,this.timeSlice||0.3)),e=(new Date).getTime()+f,h=!1;e>(new Date).getTime();){if(!this._drawNext()){h=!0;break}}if(h){this._endBuild()}else{var g=this;this._timerID=setTimeout(function(){g._run()},50-f)}f=this.progress=this._index/this._frames.length;this.onProgress&&this.onProgress(this,f);this.dispatchEvent({type:"progress",progress:f})};a._drawNext=function(){var g=this._frames[this._index],f=g.scale*this._scale,j=g.rect,i=g.sourceRect,h=this._data.images[g.img].getContext("2d");g.funct&&g.funct.apply(g.scope,g.params);h.save();h.beginPath();h.rect(j.x,j.y,j.width,j.height);h.clip();h.translate(Math.ceil(j.x-i.x*f),Math.ceil(j.y-i.y*f));h.scale(f,f);g.source.draw(h);h.restore();return ++this._index<this._frames.length};createjs.SpriteSheetBuilder=d})();this.createjs=this.createjs||{};(function(){var d=function(b){this.initialize(b)
},a=d.prototype=new createjs.DisplayObject;a.htmlElement=null;a._oldMtx=null;a.DisplayObject_initialize=a.initialize;a.initialize=function(b){"string"==typeof b&&(b=document.getElementById(b));this.DisplayObject_initialize();this.mouseEnabled=!1;this.htmlElement=b;b=b.style;b.position="absolute";b.transformOrigin=b.WebkitTransformOrigin=b.msTransformOrigin=b.MozTransformOrigin=b.OTransformOrigin="0% 0%"};a.isVisible=function(){return null!=this.htmlElement};a.draw=function(){if(null!=this.htmlElement){var f=this.getConcatenatedMatrix(this._matrix),e=this.htmlElement.style;if(this.visible){e.visibility="visible"}else{return !0}var g=this._oldMtx||{};g.alpha!=f.alpha&&(e.opacity=""+f.alpha,g.alpha=f.alpha);if(g.tx!=f.tx||g.ty!=f.ty||g.a!=f.a||g.b!=f.b||g.c!=f.c||g.d!=f.d){e.transform=e.WebkitTransform=e.OTransform=e.msTransform=["matrix("+f.a,f.b,f.c,f.d,f.tx+0.5|0,(f.ty+0.5|0)+")"].join(),e.MozTransform=["matrix("+f.a,f.b,f.c,f.d,(f.tx+0.5|0)+"px",(f.ty+0.5|0)+"px)"].join(),this._oldMtx=f.clone()}return !0}};a.cache=function(){};a.uncache=function(){};a.updateCache=function(){};a.hitTest=function(){};a.localToGlobal=function(){};a.globalToLocal=function(){};a.localToLocal=function(){};a.clone=function(){throw"DOMElement cannot be cloned."};a.toString=function(){return"[DOMElement (name="+this.name+")]"};a.DisplayObject__tick=a._tick;a._tick=function(b){this.htmlElement.style.visible="hidden";this.DisplayObject__tick(b)};createjs.DOMElement=d})();this.createjs=this.createjs||{};(function(){var d=function(){this.initialize()},a=d.prototype;a.initialize=function(){};a.getBounds=function(){return new createjs.Rectangle(0,0,0,0)};a.applyFilter=function(){};a.toString=function(){return"[Filter]"};a.clone=function(){return new d};createjs.Filter=d})();this.createjs=this.createjs||{};(function(){var a=function(){throw"Touch cannot be instantiated"};a.isSupported=function(){return"ontouchstart" in window||window.navigator.msPointerEnabled};a.enable=function(d,e,c){if(!d||!d.canvas||!a.isSupported()){return !1}d.__touch={pointers:{},multitouch:!e,preventDefault:!c,count:0};"ontouchstart" in window?a._IOS_enable(d):window.navigator.msPointerEnabled&&a._IE_enable(d);return !0};a.disable=function(c){c&&("ontouchstart" in window?a._IOS_disable(c):window.navigator.msPointerEnabled&&a._IE_disable(c))};a._IOS_enable=function(d){var e=d.canvas,c=d.__touch.f=function(b){a._IOS_handleEvent(d,b)};e.addEventListener("touchstart",c,!1);e.addEventListener("touchmove",c,!1);e.addEventListener("touchend",c,!1);e.addEventListener("touchcancel",c,!1)};a._IOS_disable=function(c){var d=c.canvas;d&&(c=c.__touch.f,d.removeEventListener("touchstart",c,!1),d.removeEventListener("touchmove",c,!1),d.removeEventListener("touchend",c,!1),d.removeEventListener("touchcancel",c,!1))};a._IOS_handleEvent=function(i,j){if(i){i.__touch.preventDefault&&j.preventDefault&&j.preventDefault();for(var p=j.changedTouches,k=j.type,o=0,n=p.length;o<n;o++){var m=p[o],l=m.identifier;m.target==i.canvas&&("touchstart"==k?this._handleStart(i,l,j,m.pageX,m.pageY):"touchmove"==k?this._handleMove(i,l,j,m.pageX,m.pageY):("touchend"==k||"touchcancel"==k)&&this._handleEnd(i,l,j))}}};a._IE_enable=function(d){var e=d.canvas,c=d.__touch.f=function(b){a._IE_handleEvent(d,b)};e.addEventListener("MSPointerDown",c,!1);window.addEventListener("MSPointerMove",c,!1);window.addEventListener("MSPointerUp",c,!1);window.addEventListener("MSPointerCancel",c,!1);d.__touch.preventDefault&&(e.style.msTouchAction="none");d.__touch.activeIDs={}};a._IE_disable=function(c){var d=c.__touch.f;window.removeEventListener("MSPointerMove",d,!1);window.removeEventListener("MSPointerUp",d,!1);window.removeEventListener("MSPointerCancel",d,!1);c.canvas&&c.canvas.removeEventListener("MSPointerDown",d,!1)};a._IE_handleEvent=function(e,f){if(e){e.__touch.preventDefault&&f.preventDefault&&f.preventDefault();var j=f.type,g=f.pointerId,i=e.__touch.activeIDs;if("MSPointerDown"==j){f.srcElement==e.canvas&&(i[g]=!0,this._handleStart(e,g,f,f.pageX,f.pageY))
}else{if(i[g]){if("MSPointerMove"==j){this._handleMove(e,g,f,f.pageX,f.pageY)}else{if("MSPointerUp"==j||"MSPointerCancel"==j){delete i[g],this._handleEnd(e,g,f)}}}}}};a._handleStart=function(g,i,n,j,m){var l=g.__touch;if(l.multitouch||!l.count){var k=l.pointers;k[i]||(k[i]=!0,l.count++,g._handlePointerDown(i,n,j,m))}};a._handleMove=function(e,f,j,g,i){e.__touch.pointers[f]&&e._handlePointerMove(f,j,g,i)};a._handleEnd=function(e,f,j){var g=e.__touch,i=g.pointers;i[f]&&(g.count--,e._handlePointerUp(f,j,!0),delete i[f])};createjs.Touch=a})();(function(){var a=this.createjs=this.createjs||{},a=a.EaselJS=a.EaselJS||{};a.version="NEXT";a.buildDate="Wed, 16 Jan 2013 23:37:24 GMT"})();(function(){var a=this.createjs=this.createjs||{},a=a.MovieClip=a.MovieClip||{};a.version="NEXT";a.buildDate="Wed, 09 Jan 2013 04:14:26 GMT"})()}(function($){var trace=function(msg){if(typeof(window)=="undefined"||!window.console){return}var len=arguments.length;var args=[];for(var i=0;i<len;i++){args.push("arguments["+i+"]")}eval("console.log("+args.join(",")+")")};var dirname=function(a){var b=a.replace(/^\/?(.*?)\/?$/,"$1").split("/");b.pop();return"/"+b.join("/")};var basename=function(b){var c=b.replace(/^\/?(.*?)\/?$/,"$1").split("/");var a=c.pop();if(a==""){return null}else{return a}};var _ordinalize_re=/(\d)(?=(\d\d\d)+(?!\d))/g;var ordinalize=function(a){var b=""+a;if(a<11000){b=(""+a).replace(_ordinalize_re,"$1,")}else{if(a<1000000){b=Math.floor(a/1000)+"k"}else{if(a<1000000000){b=(""+Math.floor(a/1000)).replace(_ordinalize_re,"$1,")+"m"}}}return b};var nano=function(a,b){return a.replace(/\{([\w\-\.]*)}/g,function(f,c){var d=c.split("."),e=b[d.shift()];$.each(d,function(){if(e.hasOwnProperty(this)){e=e[this]}else{e=f}});return e})};var objcopy=function(a){if(a===undefined){return undefined}if(a===null){return null}if(a.parentNode){return a}switch(typeof a){case"string":return a.substring(0);break;case"number":return a+0;break;case"boolean":return a===true;break}var b=($.isArray(a))?[]:{};$.each(a,function(d,c){b[d]=objcopy(c)});return b};var objmerge=function(d,b){d=d||{};b=b||{};var c=objcopy(d);for(var a in b){c[a]=b[a]}return c};var objcmp=function(e,c,d){if(!e||!c){return e===c}if(typeof e!=typeof c){return false}if(typeof e!="object"){return e===c}else{if($.isArray(e)){if(!($.isArray(c))){return false}if(e.length!=c.length){return false}}else{var h=[];for(var f in e){if(e.hasOwnProperty(f)){h.push(f)}}var g=[];for(var f in c){if(c.hasOwnProperty(f)){g.push(f)}}if(!d){h.sort();g.sort()}if(h.join(",")!==g.join(",")){return false}}var i=true;$.each(e,function(a){var b=objcmp(e[a],c[a]);i=i&&b;if(!i){return false}});return i}};var objkeys=function(b){var a=[];$.each(b,function(d,c){if(b.hasOwnProperty(d)){a.push(d)}});return a};var objcontains=function(c){if(!c||typeof c!="object"){return false}for(var b=1,a=arguments.length;b<a;b++){if(c.hasOwnProperty(arguments[b])){return true}}return false};var uniq=function(b){var a=b.length;var d={};for(var c=0;c<a;c++){d[b[c]]=true}return objkeys(d)};var arbor_path=function(){var a=$("script").map(function(b){var c=$(this).attr("src");if(!c){return}if(c.match(/arbor[^\/\.]*.js|dev.js/)){return c.match(/.*\//)||"/"}});if(a.length>0){return a[0]}else{return null}};var Kernel=function(b){var k=window.location.protocol=="file:"&&navigator.userAgent.toLowerCase().indexOf("chrome")>-1;var a=(window.Worker!==undefined&&!k);var i=null;var c=null;var f=[];f.last=new Date();var l=null;var e=null;var d=null;var h=null;var g=false;var j={system:b,tween:null,nodes:{},init:function(){if(typeof(Tween)!="undefined"){c=Tween()}else{if(typeof(arbor.Tween)!="undefined"){c=arbor.Tween()}else{c={busy:function(){return false},tick:function(){return true},to:function(){trace("Please include arbor-tween.js to enable tweens");c.to=function(){};return}}}}j.tween=c;var m=b.parameters();if(a){trace("arbor.js/web-workers",m);l=setInterval(j.screenUpdate,m.timeout);i=(m.workerUrl)?new Worker(m.workerUrl):new Worker(arbor_path()+"arbor.js");
i.onmessage=j.workerMsg;i.onerror=function(n){trace("physics:",n)};i.postMessage({type:"physics",physics:objmerge(m,{timeout:Math.ceil(m.timeout)})})}else{trace("arbor.js/single-threaded",m);i=Physics(m.dt,m.stiffness,m.repulsion,m.friction,j.system._updateGeometry,m.integrator);j.start()}return j},graphChanged:function(m){if(a){i.postMessage({type:"changes",changes:m})}else{i._update(m)}j.start()},particleModified:function(n,m){if(a){i.postMessage({type:"modify",id:n,mods:m})}else{i.modifyNode(n,m)}j.start()},physicsModified:function(m){if(!isNaN(m.timeout)){if(a){clearInterval(l);l=setInterval(j.screenUpdate,m.timeout)}else{clearInterval(d);d=null}}if(a){i.postMessage({type:"sys",param:m})}else{i.modifyPhysics(m)}j.start()},workerMsg:function(n){var m=n.data.type;if(m=="geometry"){j.workerUpdate(n.data)}else{trace("physics:",n.data)}},_lastPositions:null,workerUpdate:function(m){j._lastPositions=m;j._lastBounds=m.bounds},_lastFrametime:new Date().valueOf(),_lastBounds:null,_currentRenderer:null,screenUpdate:function(){var n=new Date().valueOf();var m=false;if(j._lastPositions!==null){j.system._updateGeometry(j._lastPositions);j._lastPositions=null;m=true}if(c&&c.busy()){m=true}if(j.system._updateBounds(j._lastBounds)){m=true}if(m){var o=j.system.renderer;if(o!==undefined){if(o!==e){o.init(j.system);e=o}if(c){c.tick()}o.redraw();var p=f.last;f.last=new Date();f.push(f.last-p);if(f.length>50){f.shift()}}}},physicsUpdate:function(){if(c){c.tick()}i.tick();var n=j.system._updateBounds();if(c&&c.busy()){n=true}var o=j.system.renderer;var m=new Date();var o=j.system.renderer;if(o!==undefined){if(o!==e){o.init(j.system);e=o}o.redraw({timestamp:m})}var q=f.last;f.last=m;f.push(f.last-q);if(f.length>50){f.shift()}var p=i.systemEnergy();if((p.mean+p.max)/2<0.05){if(h===null){h=new Date().valueOf()}if(new Date().valueOf()-h>1000){clearInterval(d);d=null}else{}}else{h=null}},fps:function(n){if(n!==undefined){var q=1000/Math.max(1,targetFps);j.physicsModified({timeout:q})}var r=0;for(var p=0,o=f.length;p<o;p++){r+=f[p]}var m=r/Math.max(1,f.length);if(!isNaN(m)){return Math.round(1000/m)}else{return 0}},start:function(m){if(d!==null){return}if(g&&!m){return}g=false;if(a){i.postMessage({type:"start"})}else{h=null;d=setInterval(j.physicsUpdate,j.system.parameters().timeout)}},stop:function(){g=true;if(a){i.postMessage({type:"stop"})}else{if(d!==null){clearInterval(d);d=null}}}};return j.init()};var Node=function(a){this._id=_nextNodeId++;this.data=a||{};this._mass=(a.mass!==undefined)?a.mass:1;this._fixed=(a.fixed===true)?true:false;this._p=new Point((typeof(a.x)=="number")?a.x:null,(typeof(a.y)=="number")?a.y:null);delete this.data.x;delete this.data.y;delete this.data.mass;delete this.data.fixed};var _nextNodeId=1;var Edge=function(b,c,a){this._id=_nextEdgeId--;this.source=b;this.target=c;this.length=(a.length!==undefined)?a.length:1;this.data=(a!==undefined)?a:{};delete this.data.length};var _nextEdgeId=-1;var Particle=function(a,b){this.p=a;this.m=b;this.v=new Point(0,0);this.f=new Point(0,0)};Particle.prototype.applyForce=function(a){this.f=this.f.add(a.divide(this.m))};var Spring=function(c,b,d,a){this.point1=c;this.point2=b;this.length=d;this.k=a};Spring.prototype.distanceToParticle=function(a){var c=that.point2.p.subtract(that.point1.p).normalize().normal();var b=a.p.subtract(that.point1.p);return Math.abs(b.x*c.x+b.y*c.y)};var Point=function(a,b){if(a&&a.hasOwnProperty("y")){b=a.y;a=a.x}this.x=a;this.y=b};Point.random=function(a){a=(a!==undefined)?a:5;return new Point(2*a*(Math.random()-0.5),2*a*(Math.random()-0.5))};Point.prototype={exploded:function(){return(isNaN(this.x)||isNaN(this.y))},add:function(a){return new Point(this.x+a.x,this.y+a.y)},subtract:function(a){return new Point(this.x-a.x,this.y-a.y)},multiply:function(a){return new Point(this.x*a,this.y*a)},divide:function(a){return new Point(this.x/a,this.y/a)},magnitude:function(){return Math.sqrt(this.x*this.x+this.y*this.y)},normal:function(){return new Point(-this.y,this.x)
},normalize:function(){return this.divide(this.magnitude())}};var ParticleSystem=function(e,s,f,g,v,m,t,a,q){var k=[];var i=null;var l=0;var w=null;var n=0.04;var j=[20,20,20,20];var o=null;var p=null;if(typeof e=="object"){var u=e;f=u.friction;e=u.repulsion;v=u.fps;m=u.dt;s=u.stiffness;g=u.gravity;t=u.precision;a=u.integrator;q=u.workerUrl}if(a!="verlet"&&a!="euler"){a="verlet"}f=isNaN(f)?0.5:f;e=isNaN(e)?1000:e;v=isNaN(v)?55:v;s=isNaN(s)?600:s;m=isNaN(m)?0.02:m;t=isNaN(t)?0.6:t;g=(g===true);var r=(v!==undefined)?1000/v:1000/50;var c={workerUrl:q,integrator:a,repulsion:e,stiffness:s,friction:f,dt:m,gravity:g,precision:t,timeout:r};var b;var d={renderer:null,tween:null,nodes:{},edges:{},adjacency:{},names:{},kernel:null};var h={parameters:function(x){if(x!==undefined){if(!isNaN(x.precision)){x.precision=Math.max(0,Math.min(1,x.precision))}$.each(c,function(z,y){if(x[z]!==undefined){c[z]=x[z]}});d.kernel.physicsModified(x)}return c},fps:function(x){if(x===undefined){return d.kernel.fps()}else{h.parameters({timeout:1000/(x||50)})}},start:function(){d.kernel.start()},stop:function(){d.kernel.stop()},addNode:function(A,D){D=D||{};var E=d.names[A];if(E){E.data=D;return E}else{if(A!=undefined){var z=(D.x!=undefined)?D.x:null;var F=(D.y!=undefined)?D.y:null;var C=(D.fixed)?1:0;var B=new Node(D);B.name=A;d.names[A]=B;d.nodes[B._id]=B;B.__defineGetter__("p",function(){var y=this;var x={};x.__defineGetter__("x",function(){return y._p.x});x.__defineSetter__("x",function(G){d.kernel.particleModified(y._id,{x:G})});x.__defineGetter__("y",function(){return y._p.y});x.__defineSetter__("y",function(G){d.kernel.particleModified(y._id,{y:G})});x.__proto__=Point.prototype;return x});B.__defineSetter__("p",function(x){this._p.x=x.x;this._p.y=x.y;d.kernel.particleModified(this._id,{x:x.x,y:x.y})});B.__defineGetter__("mass",function(){return this._mass});B.__defineSetter__("mass",function(x){this._mass=x;d.kernel.particleModified(this._id,{m:x})});B.__defineSetter__("tempMass",function(x){d.kernel.particleModified(this._id,{_m:x})});B.__defineGetter__("fixed",function(){return this._fixed});B.__defineSetter__("fixed",function(x){this._fixed=x;d.kernel.particleModified(this._id,{f:x?1:0})});k.push({t:"addNode",id:B._id,m:B.mass,x:z,y:F,f:C});h._notify();return B}}},pruneNode:function(y){var x=h.getNode(y);if(typeof(d.nodes[x._id])!=="undefined"){delete d.nodes[x._id];delete d.names[x.name]}$.each(d.edges,function(A,z){if(z.source._id===x._id||z.target._id===x._id){h.pruneEdge(z)}});k.push({t:"dropNode",id:x._id});h._notify()},getNode:function(x){if(x._id!==undefined){return x}else{if(typeof x=="string"||typeof x=="number"){return d.names[x]}}},eachNode:function(x){$.each(d.nodes,function(A,z){if(z._p.x==null||z._p.y==null){return}var y=(w!==null)?h.toScreen(z._p):z._p;x.call(h,z,y)})},addEdge:function(B,C,A){B=h.getNode(B)||h.addNode(B);C=h.getNode(C)||h.addNode(C);A=A||{};var z=new Edge(B,C,A);var D=B._id;var E=C._id;d.adjacency[D]=d.adjacency[D]||{};d.adjacency[D][E]=d.adjacency[D][E]||[];var y=(d.adjacency[D][E].length>0);if(y){$.extend(d.adjacency[D][E].data,z.data);return}else{d.edges[z._id]=z;d.adjacency[D][E].push(z);var x=(z.length!==undefined)?z.length:1;k.push({t:"addSpring",id:z._id,fm:D,to:E,l:x});h._notify()}return z},pruneEdge:function(C){k.push({t:"dropSpring",id:C._id});delete d.edges[C._id];for(var z in d.adjacency){for(var D in d.adjacency[z]){var A=d.adjacency[z][D];for(var B=A.length-1;B>=0;B--){if(d.adjacency[z][D][B]._id===C._id){d.adjacency[z][D].splice(B,1)}}}}h._notify()},getEdges:function(y,x){y=h.getNode(y);x=h.getNode(x);if(!y||!x){return[]}if(typeof(d.adjacency[y._id])!=="undefined"&&typeof(d.adjacency[y._id][x._id])!=="undefined"){return d.adjacency[y._id][x._id]}return[]},getEdgesFrom:function(x){x=h.getNode(x);if(!x){return[]}if(typeof(d.adjacency[x._id])!=="undefined"){var y=[];$.each(d.adjacency[x._id],function(A,z){y=y.concat(z)});return y}return[]},getEdgesTo:function(x){x=h.getNode(x);if(!x){return[]}var y=[];$.each(d.edges,function(A,z){if(z.target==x){y.push(z)
}});return y},eachEdge:function(x){$.each(d.edges,function(B,z){var A=d.nodes[z.source._id]._p;var y=d.nodes[z.target._id]._p;if(A.x==null||y.x==null){return}A=(w!==null)?h.toScreen(A):A;y=(w!==null)?h.toScreen(y):y;if(A&&y){x.call(h,z,A,y)}})},prune:function(y){var x={dropped:{nodes:[],edges:[]}};if(y===undefined){$.each(d.nodes,function(A,z){x.dropped.nodes.push(z);h.pruneNode(z)})}else{h.eachNode(function(A){var z=y.call(h,A,{from:h.getEdgesFrom(A),to:h.getEdgesTo(A)});if(z){x.dropped.nodes.push(A);h.pruneNode(A)}})}return x},graft:function(y){var x={added:{nodes:[],edges:[]}};if(y.nodes){$.each(y.nodes,function(A,z){var B=h.getNode(A);if(B){B.data=z}else{x.added.nodes.push(h.addNode(A,z))}d.kernel.start()})}if(y.edges){$.each(y.edges,function(B,z){var A=h.getNode(B);if(!A){x.added.nodes.push(h.addNode(B,{}))}$.each(z,function(F,C){var E=h.getNode(F);if(!E){x.added.nodes.push(h.addNode(F,{}))}var D=h.getEdges(B,F);if(D.length>0){D[0].data=C}else{x.added.edges.push(h.addEdge(B,F,C))}})})}return x},merge:function(y){var x={added:{nodes:[],edges:[]},dropped:{nodes:[],edges:[]}};$.each(d.edges,function(C,B){if((y.edges[B.source.name]===undefined||y.edges[B.source.name][B.target.name]===undefined)){h.pruneEdge(B);x.dropped.edges.push(B)}});var A=h.prune(function(C,B){if(y.nodes[C.name]===undefined){x.dropped.nodes.push(C);return true}});var z=h.graft(y);x.added.nodes=x.added.nodes.concat(z.added.nodes);x.added.edges=x.added.edges.concat(z.added.edges);x.dropped.nodes=x.dropped.nodes.concat(A.dropped.nodes);x.dropped.edges=x.dropped.edges.concat(A.dropped.edges);return x},tweenNode:function(A,x,z){var y=h.getNode(A);if(y){d.tween.to(y,x,z)}},tweenEdge:function(y,x,B,A){if(A===undefined){h._tweenEdge(y,x,B)}else{var z=h.getEdges(y,x);$.each(z,function(C,D){h._tweenEdge(D,B,A)})}},_tweenEdge:function(y,x,z){if(y&&y._id!==undefined){d.tween.to(y,x,z)}},_updateGeometry:function(A){if(A!=undefined){var x=(A.epoch<l);b=A.energy;var B=A.geometry;if(B!==undefined){for(var z=0,y=B.length/3;z<y;z++){var C=B[3*z];if(x&&d.nodes[C]==undefined){continue}d.nodes[C]._p.x=B[3*z+1];d.nodes[C]._p.y=B[3*z+2]}}}},screen:function(x){if(x==undefined){return{size:(w)?objcopy(w):undefined,padding:j.concat(),step:n}}if(x.size!==undefined){h.screenSize(x.size.width,x.size.height)}if(!isNaN(x.step)){h.screenStep(x.step)}if(x.padding!==undefined){h.screenPadding(x.padding)}},screenSize:function(x,y){w={width:x,height:y};h._updateBounds()},screenPadding:function(A,B,x,y){if($.isArray(A)){trbl=A}else{trbl=[A,B,x,y]}var C=trbl[0];var z=trbl[1];var D=trbl[2];if(z===undefined){trbl=[C,C,C,C]}else{if(D==undefined){trbl=[C,z,C,z]}}j=trbl},screenStep:function(x){n=x},toScreen:function(z){if(!o||!w){return}var y=j||[0,0,0,0];var x=o.bottomright.subtract(o.topleft);var B=y[3]+z.subtract(o.topleft).divide(x.x).x*(w.width-(y[1]+y[3]));var A=y[0]+z.subtract(o.topleft).divide(x.y).y*(w.height-(y[0]+y[2]));return arbor.Point(B,A)},fromScreen:function(B){if(!o||!w){return}var A=j||[0,0,0,0];var z=o.bottomright.subtract(o.topleft);var y=(B.x-A[3])/(w.width-(A[1]+A[3]))*z.x+o.topleft.x;var x=(B.y-A[0])/(w.height-(A[0]+A[2]))*z.y+o.topleft.y;return arbor.Point(y,x)},_updateBounds:function(y){if(w===null){return}if(y){p=y}else{p=h.bounds()}var B=new Point(p.bottomright.x,p.bottomright.y);var A=new Point(p.topleft.x,p.topleft.y);var D=B.subtract(A);var x=A.add(D.divide(2));var z=4;var F=new Point(Math.max(D.x,z),Math.max(D.y,z));p.topleft=x.subtract(F.divide(2));p.bottomright=x.add(F.divide(2));if(!o){if($.isEmptyObject(d.nodes)){return false}o=p;return true}var E=n;_newBounds={bottomright:o.bottomright.add(p.bottomright.subtract(o.bottomright).multiply(E)),topleft:o.topleft.add(p.topleft.subtract(o.topleft).multiply(E))};var C=new Point(o.topleft.subtract(_newBounds.topleft).magnitude(),o.bottomright.subtract(_newBounds.bottomright).magnitude());if(C.x*w.width>1||C.y*w.height>1){o=_newBounds;return true}else{return false}},energy:function(){return b},bounds:function(){var y=null;
var x=null;$.each(d.nodes,function(B,A){if(!y){y=new Point(A._p);x=new Point(A._p);return}var z=A._p;if(z.x===null||z.y===null){return}if(z.x>y.x){y.x=z.x}if(z.y>y.y){y.y=z.y}if(z.x<x.x){x.x=z.x}if(z.y<x.y){x.y=z.y}});if(y&&x){return{bottomright:y,topleft:x}}else{return{topleft:new Point(-1,-1),bottomright:new Point(1,1)}}},nearest:function(z){if(w!==null){z=h.fromScreen(z)}var y={node:null,point:null,distance:null};var x=h;$.each(d.nodes,function(D,A){var B=A._p;if(B.x===null||B.y===null){return}var C=B.subtract(z).magnitude();if(y.distance===null||C<y.distance){y={node:A,point:B,distance:C};if(w!==null){y.screenPoint=h.toScreen(B)}}});if(y.node){if(w!==null){y.distance=h.toScreen(y.node.p).subtract(h.toScreen(z)).magnitude()}return y}else{return null}},_notify:function(){if(i===null){l++}else{clearTimeout(i)}i=setTimeout(h._synchronize,20)},_synchronize:function(){if(k.length>0){d.kernel.graphChanged(k);k=[];i=null}},};d.kernel=Kernel(h);d.tween=d.kernel.tween||null;return h};var BarnesHutTree=function(){var b=[];var a=0;var e=null;var d=0.5;var c={init:function(g,h,f){d=f;a=0;e=c._newBranch();e.origin=g;e.size=h.subtract(g)},insert:function(j){var f=e;var g=[j];while(g.length){var h=g.shift();var m=h._m||h.m;var p=c._whichQuad(h,f);if(f[p]===undefined){f[p]=h;f.mass+=m;if(f.p){f.p=f.p.add(h.p.multiply(m))}else{f.p=h.p.multiply(m)}}else{if("origin" in f[p]){f.mass+=(m);if(f.p){f.p=f.p.add(h.p.multiply(m))}else{f.p=h.p.multiply(m)}f=f[p];g.unshift(h)}else{var l=f.size.divide(2);var n=new Point(f.origin);if(p[0]=="s"){n.y+=l.y}if(p[1]=="e"){n.x+=l.x}var o=f[p];f[p]=c._newBranch();f[p].origin=n;f[p].size=l;f.mass=m;f.p=h.p.multiply(m);f=f[p];if(o.p.x===h.p.x&&o.p.y===h.p.y){var k=l.x*0.08;var i=l.y*0.08;o.p.x=Math.min(n.x+l.x,Math.max(n.x,o.p.x-k/2+Math.random()*k));o.p.y=Math.min(n.y+l.y,Math.max(n.y,o.p.y-i/2+Math.random()*i))}g.push(o);g.unshift(h)}}}},applyForces:function(m,g){var f=[e];while(f.length){node=f.shift();if(node===undefined){continue}if(m===node){continue}if("f" in node){var k=m.p.subtract(node.p);var l=Math.max(1,k.magnitude());var i=((k.magnitude()>0)?k:Point.random(1)).normalize();m.applyForce(i.multiply(g*(node._m||node.m)).divide(l*l))}else{var j=m.p.subtract(node.p.divide(node.mass)).magnitude();var h=Math.sqrt(node.size.x*node.size.y);if(h/j>d){f.push(node.ne);f.push(node.nw);f.push(node.se);f.push(node.sw)}else{var k=m.p.subtract(node.p.divide(node.mass));var l=Math.max(1,k.magnitude());var i=((k.magnitude()>0)?k:Point.random(1)).normalize();m.applyForce(i.multiply(g*(node.mass)).divide(l*l))}}}},_whichQuad:function(i,f){if(i.p.exploded()){return null}var h=i.p.subtract(f.origin);var g=f.size.divide(2);if(h.y<g.y){if(h.x<g.x){return"nw"}else{return"ne"}}else{if(h.x<g.x){return"sw"}else{return"se"}}},_newBranch:function(){if(b[a]){var f=b[a];f.ne=f.nw=f.se=f.sw=undefined;f.mass=0;delete f.p}else{f={origin:null,size:null,nw:undefined,ne:undefined,sw:undefined,se:undefined,mass:0};b[a]=f}a++;return f}};return c};var Physics=function(a,m,n,e,h,o){var f=BarnesHutTree();var c={particles:{},springs:{}};var l={particles:{}};var p=[];var k=[];var d=0;var b={sum:0,max:0,mean:0};var g={topleft:new Point(-1,-1),bottomright:new Point(1,1)};var j=1000;var i={integrator:["verlet","euler"].indexOf(o)>=0?o:"verlet",stiffness:(m!==undefined)?m:1000,repulsion:(n!==undefined)?n:600,friction:(e!==undefined)?e:0.3,gravity:false,dt:(a!==undefined)?a:0.02,theta:0.4,init:function(){return i},modifyPhysics:function(q){$.each(["stiffness","repulsion","friction","gravity","dt","precision","integrator"],function(s,t){if(q[t]!==undefined){if(t=="precision"){i.theta=1-q[t];return}i[t]=q[t];if(t=="stiffness"){var r=q[t];$.each(c.springs,function(v,u){u.k=r})}}})},addNode:function(v){var u=v.id;var r=v.m;var q=g.bottomright.x-g.topleft.x;var t=g.bottomright.y-g.topleft.y;var s=new Point((v.x!=null)?v.x:g.topleft.x+q*Math.random(),(v.y!=null)?v.y:g.topleft.y+t*Math.random());c.particles[u]=new Particle(s,r);c.particles[u].connections=0;c.particles[u].fixed=(v.f===1);
l.particles[u]=c.particles[u];p.push(c.particles[u])},dropNode:function(t){var s=t.id;var r=c.particles[s];var q=$.inArray(r,p);if(q>-1){p.splice(q,1)}delete c.particles[s];delete l.particles[s]},modifyNode:function(s,q){if(s in c.particles){var r=c.particles[s];if("x" in q){r.p.x=q.x}if("y" in q){r.p.y=q.y}if("m" in q){r.m=q.m}if("f" in q){r.fixed=(q.f===1)}if("_m" in q){if(r._m===undefined){r._m=r.m}r.m=q._m}}},addSpring:function(u){var t=u.id;var q=u.l;var s=c.particles[u.fm];var r=c.particles[u.to];if(s!==undefined&&r!==undefined){c.springs[t]=new Spring(s,r,q,i.stiffness);k.push(c.springs[t]);s.connections++;r.connections++;delete l.particles[u.fm];delete l.particles[u.to]}},dropSpring:function(t){var s=t.id;var r=c.springs[s];r.point1.connections--;r.point2.connections--;var q=$.inArray(r,k);if(q>-1){k.splice(q,1)}delete c.springs[s]},_update:function(q){d++;$.each(q,function(r,s){if(s.t in i){i[s.t](s)}});return d},tick:function(){i.tendParticles();if(i.integrator=="euler"){i.updateForces();i.updateVelocity(i.dt);i.updatePosition(i.dt)}else{i.updateForces();i.cacheForces();i.updatePosition(i.dt);i.updateForces();i.updateVelocity(i.dt)}i.tock()},tock:function(){var q=[];$.each(c.particles,function(s,r){q.push(s);q.push(r.p.x);q.push(r.p.y)});if(h){h({geometry:q,epoch:d,energy:b,bounds:g})}},tendParticles:function(){$.each(c.particles,function(r,q){if(q._m!==undefined){if(Math.abs(q.m-q._m)<1){q.m=q._m;delete q._m}else{q.m*=0.98}}q.v.x=q.v.y=0})},updateForces:function(){if(i.repulsion>0){if(i.theta>0){i.applyBarnesHutRepulsion()}else{i.applyBruteForceRepulsion()}}if(i.stiffness>0){i.applySprings()}i.applyCenterDrift();if(i.gravity){i.applyCenterGravity()}},cacheForces:function(){$.each(c.particles,function(r,q){q._F=q.f})},applyBruteForceRepulsion:function(){$.each(c.particles,function(r,q){$.each(c.particles,function(t,s){if(q!==s){var v=q.p.subtract(s.p);var w=Math.max(1,v.magnitude());var u=((v.magnitude()>0)?v:Point.random(1)).normalize();q.applyForce(u.multiply(i.repulsion*(s._m||s.m)*0.5).divide(w*w*0.5));s.applyForce(u.multiply(i.repulsion*(q._m||q.m)*0.5).divide(w*w*-0.5))}})})},applyBarnesHutRepulsion:function(){if(!g.topleft||!g.bottomright){return}var r=new Point(g.bottomright);var q=new Point(g.topleft);f.init(q,r,i.theta);$.each(c.particles,function(t,s){f.insert(s)});$.each(c.particles,function(t,s){f.applyForces(s,i.repulsion)})},applySprings:function(){$.each(c.springs,function(u,q){var t=q.point2.p.subtract(q.point1.p);var r=q.length-t.magnitude();var s=((t.magnitude()>0)?t:Point.random(1)).normalize();q.point1.applyForce(s.multiply(q.k*r*-0.5));q.point2.applyForce(s.multiply(q.k*r*0.5))})},applyCenterDrift:function(){var r=0;var s=new Point(0,0);$.each(c.particles,function(u,t){s.add(t.p);r++});if(r==0){return}var q=s.divide(-r);$.each(c.particles,function(u,t){t.applyForce(q)})},applyCenterGravity:function(){$.each(c.particles,function(s,q){var r=q.p.multiply(-1);q.applyForce(r.multiply(i.repulsion/100))})},updateVelocity:function(r){var s=0,q=0,t=0;$.each(c.particles,function(x,u){if(u.fixed){u.v=new Point(0,0);u.f=new Point(0,0);return}if(i.integrator=="euler"){u.v=u.v.add(u.f.multiply(r)).multiply(1-i.friction)}else{u.v=u.v.add(u.f.add(u._F.divide(u._m)).multiply(r*0.5)).multiply(1-i.friction)}u.f.x=u.f.y=0;var v=u.v.magnitude();if(v>j){u.v=u.v.divide(v*v)}var v=u.v.magnitude();var w=v*v;s+=w;q=Math.max(w,q);t++});b={sum:s,max:q,mean:s/t,n:t}},updatePosition:function(q){var s=null;var r=null;$.each(c.particles,function(v,t){if(i.integrator=="euler"){t.p=t.p.add(t.v.multiply(q))}else{var u=t.f.multiply(0.5*q*q).divide(t.m);t.p=t.p.add(t.v.multiply(q)).add(u)}if(!s){s=new Point(t.p.x,t.p.y);r=new Point(t.p.x,t.p.y);return}var w=t.p;if(w.x===null||w.y===null){return}if(w.x>s.x){s.x=w.x}if(w.y>s.y){s.y=w.y}if(w.x<r.x){r.x=w.x}if(w.y<r.y){r.y=w.y}});g={topleft:r||new Point(-1,-1),bottomright:s||new Point(1,1)}},systemEnergy:function(q){return b}};return i.init()};var _nearParticle=function(b,c){var c=c||0;
var a=b.x;var f=b.y;var e=c*2;return new Point(a-c+Math.random()*e,f-c+Math.random()*e)};if(typeof(window)=="undefined"){return(function(){$={each:function(d,e){if($.isArray(d)){for(var c=0,b=d.length;c<b;c++){e(c,d[c])}}else{for(var a in d){e(a,d[a])}}},map:function(a,c){var b=[];$.each(a,function(f,e){var d=c(e);if(d!==undefined){b.push(d)}});return b},extend:function(c,b){if(typeof b!="object"){return c}for(var a in b){if(b.hasOwnProperty(a)){c[a]=b[a]}}return c},isArray:function(a){if(!a){return false}return(a.constructor.toString().indexOf("Array")!=-1)},inArray:function(c,a){for(var d=0,b=a.length;d<b;d++){if(a[d]===c){return d}}return -1},isEmptyObject:function(a){if(typeof a!=="object"){return false}var b=true;$.each(a,function(c,d){b=false});return b},};var PhysicsWorker=function(){var b=20;var a=null;var d=null;var c=null;var g=[];var f=new Date().valueOf();var e={init:function(h){e.timeout(h.timeout);a=Physics(h.dt,h.stiffness,h.repulsion,h.friction,e.tock);return e},timeout:function(h){if(h!=b){b=h;if(d!==null){e.stop();e.go()}}},go:function(){if(d!==null){return}c=null;d=setInterval(e.tick,b)},stop:function(){if(d===null){return}clearInterval(d);d=null},tick:function(){a.tick();var h=a.systemEnergy();if((h.mean+h.max)/2<0.05){if(c===null){c=new Date().valueOf()}if(new Date().valueOf()-c>1000){e.stop()}else{}}else{c=null}},tock:function(h){h.type="geometry";postMessage(h)},modifyNode:function(i,h){a.modifyNode(i,h);e.go()},modifyPhysics:function(h){a.modifyPhysics(h)},update:function(h){var i=a._update(h)}};return e};var physics=PhysicsWorker();onmessage=function(a){if(!a.data.type){postMessage("¿kérnèl?");return}if(a.data.type=="physics"){var b=a.data.physics;physics.init(a.data.physics);return}switch(a.data.type){case"modify":physics.modifyNode(a.data.id,a.data.mods);break;case"changes":physics.update(a.data.changes);physics.go();break;case"start":physics.go();break;case"stop":physics.stop();break;case"sys":var b=a.data.param||{};if(!isNaN(b.timeout)){physics.timeout(b.timeout)}physics.modifyPhysics(b);physics.go();break}}})()}arbor=(typeof(arbor)!=="undefined")?arbor:{};$.extend(arbor,{ParticleSystem:ParticleSystem,Point:function(x,y){return new Point(x,y)},etc:{trace:trace,dirname:dirname,basename:basename,ordinalize:ordinalize,objcopy:objcopy,objcmp:objcmp,objkeys:objkeys,objmerge:objmerge,uniq:uniq,arbor_path:arbor_path,}})})(this.jQuery);(function($){var trace=function(msg){if(typeof(window)=="undefined"||!window.console){return}var len=arguments.length;var args=[];for(var i=0;i<len;i++){args.push("arguments["+i+"]")}eval("console.log("+args.join(",")+")")};var dirname=function(a){var b=a.replace(/^\/?(.*?)\/?$/,"$1").split("/");b.pop();return"/"+b.join("/")};var basename=function(b){var c=b.replace(/^\/?(.*?)\/?$/,"$1").split("/");var a=c.pop();if(a==""){return null}else{return a}};var _ordinalize_re=/(\d)(?=(\d\d\d)+(?!\d))/g;var ordinalize=function(a){var b=""+a;if(a<11000){b=(""+a).replace(_ordinalize_re,"$1,")}else{if(a<1000000){b=Math.floor(a/1000)+"k"}else{if(a<1000000000){b=(""+Math.floor(a/1000)).replace(_ordinalize_re,"$1,")+"m"}}}return b};var nano=function(a,b){return a.replace(/\{([\w\-\.]*)}/g,function(f,c){var d=c.split("."),e=b[d.shift()];$.each(d,function(){if(e.hasOwnProperty(this)){e=e[this]}else{e=f}});return e})};var objcopy=function(a){if(a===undefined){return undefined}if(a===null){return null}if(a.parentNode){return a}switch(typeof a){case"string":return a.substring(0);break;case"number":return a+0;break;case"boolean":return a===true;break}var b=($.isArray(a))?[]:{};$.each(a,function(d,c){b[d]=objcopy(c)});return b};var objmerge=function(d,b){d=d||{};b=b||{};var c=objcopy(d);for(var a in b){c[a]=b[a]}return c};var objcmp=function(e,c,d){if(!e||!c){return e===c}if(typeof e!=typeof c){return false}if(typeof e!="object"){return e===c}else{if($.isArray(e)){if(!($.isArray(c))){return false}if(e.length!=c.length){return false}}else{var h=[];for(var f in e){if(e.hasOwnProperty(f)){h.push(f)}}var g=[];
for(var f in c){if(c.hasOwnProperty(f)){g.push(f)}}if(!d){h.sort();g.sort()}if(h.join(",")!==g.join(",")){return false}}var i=true;$.each(e,function(a){var b=objcmp(e[a],c[a]);i=i&&b;if(!i){return false}});return i}};var objkeys=function(b){var a=[];$.each(b,function(d,c){if(b.hasOwnProperty(d)){a.push(d)}});return a};var objcontains=function(c){if(!c||typeof c!="object"){return false}for(var b=1,a=arguments.length;b<a;b++){if(c.hasOwnProperty(arguments[b])){return true}}return false};var uniq=function(b){var a=b.length;var d={};for(var c=0;c<a;c++){d[b[c]]=true}return objkeys(d)};var arbor_path=function(){var a=$("script").map(function(b){var c=$(this).attr("src");if(!c){return}if(c.match(/arbor[^\/\.]*.js|dev.js/)){return c.match(/.*\//)||"/"}});if(a.length>0){return a[0]}else{return null}};var Colors=(function(){var f=/#[0-9a-f]{6}/i;var b=/#(..)(..)(..)/;var c=function(h){var g=h.toString(16);return(g.length==2)?g:"0"+g};var a=function(g){return parseInt(g,16)};var d=function(g){if(!g||typeof g!="object"){return false}var h=objkeys(g).sort().join("");if(h=="abgr"){return true}};var e={CSS:{aliceblue:"#f0f8ff",antiquewhite:"#faebd7",aqua:"#00ffff",aquamarine:"#7fffd4",azure:"#f0ffff",beige:"#f5f5dc",bisque:"#ffe4c4",black:"#000000",blanchedalmond:"#ffebcd",blue:"#0000ff",blueviolet:"#8a2be2",brown:"#a52a2a",burlywood:"#deb887",cadetblue:"#5f9ea0",chartreuse:"#7fff00",chocolate:"#d2691e",coral:"#ff7f50",cornflowerblue:"#6495ed",cornsilk:"#fff8dc",crimson:"#dc143c",cyan:"#00ffff",darkblue:"#00008b",darkcyan:"#008b8b",darkgoldenrod:"#b8860b",darkgray:"#a9a9a9",darkgrey:"#a9a9a9",darkgreen:"#006400",darkkhaki:"#bdb76b",darkmagenta:"#8b008b",darkolivegreen:"#556b2f",darkorange:"#ff8c00",darkorchid:"#9932cc",darkred:"#8b0000",darksalmon:"#e9967a",darkseagreen:"#8fbc8f",darkslateblue:"#483d8b",darkslategray:"#2f4f4f",darkslategrey:"#2f4f4f",darkturquoise:"#00ced1",darkviolet:"#9400d3",deeppink:"#ff1493",deepskyblue:"#00bfff",dimgray:"#696969",dimgrey:"#696969",dodgerblue:"#1e90ff",firebrick:"#b22222",floralwhite:"#fffaf0",forestgreen:"#228b22",fuchsia:"#ff00ff",gainsboro:"#dcdcdc",ghostwhite:"#f8f8ff",gold:"#ffd700",goldenrod:"#daa520",gray:"#808080",grey:"#808080",green:"#008000",greenyellow:"#adff2f",honeydew:"#f0fff0",hotpink:"#ff69b4",indianred:"#cd5c5c",indigo:"#4b0082",ivory:"#fffff0",khaki:"#f0e68c",lavender:"#e6e6fa",lavenderblush:"#fff0f5",lawngreen:"#7cfc00",lemonchiffon:"#fffacd",lightblue:"#add8e6",lightcoral:"#f08080",lightcyan:"#e0ffff",lightgoldenrodyellow:"#fafad2",lightgray:"#d3d3d3",lightgrey:"#d3d3d3",lightgreen:"#90ee90",lightpink:"#ffb6c1",lightsalmon:"#ffa07a",lightseagreen:"#20b2aa",lightskyblue:"#87cefa",lightslategray:"#778899",lightslategrey:"#778899",lightsteelblue:"#b0c4de",lightyellow:"#ffffe0",lime:"#00ff00",limegreen:"#32cd32",linen:"#faf0e6",magenta:"#ff00ff",maroon:"#800000",mediumaquamarine:"#66cdaa",mediumblue:"#0000cd",mediumorchid:"#ba55d3",mediumpurple:"#9370d8",mediumseagreen:"#3cb371",mediumslateblue:"#7b68ee",mediumspringgreen:"#00fa9a",mediumturquoise:"#48d1cc",mediumvioletred:"#c71585",midnightblue:"#191970",mintcream:"#f5fffa",mistyrose:"#ffe4e1",moccasin:"#ffe4b5",navajowhite:"#ffdead",navy:"#000080",oldlace:"#fdf5e6",olive:"#808000",olivedrab:"#6b8e23",orange:"#ffa500",orangered:"#ff4500",orchid:"#da70d6",palegoldenrod:"#eee8aa",palegreen:"#98fb98",paleturquoise:"#afeeee",palevioletred:"#d87093",papayawhip:"#ffefd5",peachpuff:"#ffdab9",peru:"#cd853f",pink:"#ffc0cb",plum:"#dda0dd",powderblue:"#b0e0e6",purple:"#800080",red:"#ff0000",rosybrown:"#bc8f8f",royalblue:"#4169e1",saddlebrown:"#8b4513",salmon:"#fa8072",sandybrown:"#f4a460",seagreen:"#2e8b57",seashell:"#fff5ee",sienna:"#a0522d",silver:"#c0c0c0",skyblue:"#87ceeb",slateblue:"#6a5acd",slategray:"#708090",slategrey:"#708090",snow:"#fffafa",springgreen:"#00ff7f",steelblue:"#4682b4",tan:"#d2b48c",teal:"#008080",thistle:"#d8bfd8",tomato:"#ff6347",turquoise:"#40e0d0",violet:"#ee82ee",wheat:"#f5deb3",white:"#ffffff",whitesmoke:"#f5f5f5",yellow:"#ffff00",yellowgreen:"#9acd32"},decode:function(h){var g=arguments.length;
for(var l=g-1;l>=0;l--){if(arguments[l]===undefined){g--}}var k=arguments;if(!h){return null}if(g==1&&d(h)){return h}var j=null;if(typeof h=="string"){var o=1;if(g==2){o=k[1]}var n=e.CSS[h.toLowerCase()];if(n!==undefined){h=n}var m=h.match(f);if(m){vals=h.match(b);if(!vals||!vals.length||vals.length!=4){return null}j={r:a(vals[1]),g:a(vals[2]),b:a(vals[3]),a:o}}}else{if(typeof h=="number"){if(g>=3){j={r:k[0],g:k[1],b:k[2],a:1};if(g>=4){j.a*=k[3]}}else{if(g>=1){j={r:k[0],g:k[0],b:k[0],a:1};if(g==2){j.a*=k[1]}}}}}return j},validate:function(g){if(!g||typeof g!="string"){return false}if(e.CSS[g.toLowerCase()]!==undefined){return true}if(g.match(f)){return true}return false},mix:function(h,g,k){var j=e.decode(h);var i=e.decode(g)},blend:function(g,j){j=(j!==undefined)?Math.max(0,Math.min(1,j)):1;var h=e.decode(g);if(!h){return null}if(j==1){return g}var h=g;if(typeof g=="string"){h=e.decode(g)}var i=objcopy(h);i.a*=j;return nano("rgba({r},{g},{b},{a})",i)},encode:function(g){if(!d(g)){g=e.decode(g);if(!d(g)){return null}}if(g.a==1){return nano("#{r}{g}{b}",{r:c(g.r),g:c(g.g),b:c(g.b)})}else{return nano("rgba({r},{g},{b},{a})",g)}}};return e})();var Primitives=function(c,f,g){var b=function(i,m,j,l,k){this.x=i;this.y=m;this.w=j;this.h=l;this.style=(k!==undefined)?k:{}};b.prototype={draw:function(h){this._draw(h)},_draw:function(i,n,j,l,k){if(objcontains(i,"stroke","fill","width")){k=i}if(this.x!==undefined){i=this.x,n=this.y,j=this.w,l=this.h;k=objmerge(this.style,k)}k=objmerge(f,k);if(!k.stroke&&!k.fill){return}var m=0.5522848;ox=(j/2)*m,oy=(l/2)*m,xe=i+j,ye=n+l,xm=i+j/2,ym=n+l/2;c.save();c.beginPath();c.moveTo(i,ym);c.bezierCurveTo(i,ym-oy,xm-ox,n,xm,n);c.bezierCurveTo(xm+ox,n,xe,ym-oy,xe,ym);c.bezierCurveTo(xe,ym+oy,xm+ox,ye,xm,ye);c.bezierCurveTo(xm-ox,ye,i,ym+oy,i,ym);c.closePath();if(k.fill!==null){if(k.alpha!==undefined){c.fillStyle=Colors.blend(k.fill,k.alpha)}else{c.fillStyle=Colors.encode(k.fill)}c.fill()}if(k.stroke!==null){c.strokeStyle=Colors.encode(k.stroke);if(!isNaN(k.width)){c.lineWidth=k.width}c.stroke()}c.restore()}};var a=function(i,n,j,l,m,k){if(objcontains(m,"stroke","fill","width")){k=m;m=0}this.x=i;this.y=n;this.w=j;this.h=l;this.r=(m!==undefined)?m:0;this.style=(k!==undefined)?k:{}};a.prototype={draw:function(h){this._draw(h)},_draw:function(j,o,k,m,n,l){if(objcontains(n,"stroke","fill","width","alpha")){l=n;n=0}else{if(objcontains(j,"stroke","fill","width","alpha")){l=j}}if(this.x!==undefined){j=this.x,o=this.y,k=this.w,m=this.h;l=objmerge(this.style,l)}l=objmerge(f,l);if(!l.stroke&&!l.fill){return}var i=(n>0);c.save();c.beginPath();c.moveTo(j+n,o);c.lineTo(j+k-n,o);if(i){c.quadraticCurveTo(j+k,o,j+k,o+n)}c.lineTo(j+k,o+m-n);if(i){c.quadraticCurveTo(j+k,o+m,j+k-n,o+m)}c.lineTo(j+n,o+m);if(i){c.quadraticCurveTo(j,o+m,j,o+m-n)}c.lineTo(j,o+n);if(i){c.quadraticCurveTo(j,o,j+n,o)}if(l.fill!==null){if(l.alpha!==undefined){c.fillStyle=Colors.blend(l.fill,l.alpha)}else{c.fillStyle=Colors.encode(l.fill)}c.fill()}if(l.stroke!==null){c.strokeStyle=Colors.encode(l.stroke);if(!isNaN(l.width)){c.lineWidth=l.width}c.stroke()}c.restore()}};var e=function(i,l,h,j,k){if(k!==undefined||typeof j=="number"){this.points=[{x:i,y:l},{x:h,y:j}];this.style=k||{}}else{if($.isArray(i)){this.points=i;this.style=l||{}}else{this.points=[i,l];this.style=h||{}}}};e.prototype={draw:function(h){if(this.points.length<2){return}var j=[];if(!$.isArray(this.points[0])){j.push(this.points)}else{j=this.points}c.save();c.beginPath();$.each(j,function(n,m){c.moveTo(m[0].x+0.5,m[0].y+0.5);$.each(m,function(o,p){if(o==0){return}c.lineTo(p.x+0.5,p.y+0.5)})});var i=$.extend(objmerge(f,this.style),h);if(i.closed){c.closePath()}if(i.fill!==undefined){var l=Colors.decode(i.fill,(i.alpha!==undefined)?i.alpha:1);if(l){c.fillStyle=Colors.encode(l)}c.fill()}if(i.stroke!==undefined){var k=Colors.decode(i.stroke,(i.alpha!==undefined)?i.alpha:1);if(k){c.strokeStyle=Colors.encode(k)}if(!isNaN(i.width)){c.lineWidth=i.width}c.stroke()}c.restore()}};var d=function(i,h,l,k){var j=Colors.decode(i,h,l,k);
if(j){this.r=j.r;this.g=j.g;this.b=j.b;this.a=j.a}};d.prototype={toString:function(){return Colors.encode(this)},blend:function(){trace("blend",this.r,this.g,this.b,this.a)}};return{_Oval:b,_Rect:a,_Color:d,_Path:e}};var Graphics=function(c){var h=$(c);var q=$(h).get(0).getContext("2d");var i=null;var l="rgb";var e="origin";var m={};var p={background:null,fill:null,stroke:null,width:0};var b={};var g={font:"sans-serif",size:12,align:"left",color:Colors.decode("black"),alpha:1,baseline:"ideographic"};var k=[];var o=Primitives(q,p,g);var f=o._Oval;var n=o._Rect;var d=o._Color;var a=o._Path;var j={init:function(){if(!q){return null}return j},size:function(s,r){if(!isNaN(s)&&!isNaN(r)){h.attr({width:s,height:r})}return{width:h.attr("width"),height:h.attr("height")}},clear:function(r,u,s,t){if(arguments.length<4){r=0;u=0;s=h.attr("width");t=h.attr("height")}q.clearRect(r,u,s,t);if(p.background!==null){q.save();q.fillStyle=Colors.encode(p.background);q.fillRect(r,u,s,t);q.restore()}},background:function(s,r,v,t){if(s==null){p.background=null;return null}var u=Colors.decode(s,r,v,t);if(u){p.background=u;j.clear()}},noFill:function(){p.fill=null},fill:function(s,r,v,t){if(arguments.length==0){return p.fill}else{if(arguments.length>0){var u=Colors.decode(s,r,v,t);p.fill=u;q.fillStyle=Colors.encode(u)}}},noStroke:function(){p.stroke=null;q.strokeStyle=null},stroke:function(s,r,v,u){if(arguments.length==0&&p.stroke!==null){return p.stroke}else{if(arguments.length>0){var t=Colors.decode(s,r,v,u);p.stroke=t;q.strokeStyle=Colors.encode(t)}}},strokeWidth:function(r){if(r===undefined){return q.lineWidth}q.lineWidth=p.width=r},Color:function(r){return new d(r)},drawStyle:function(s){if(arguments.length==0){return objcopy(p)}if(arguments.length==2){var r=arguments[0];var v=arguments[1];if(typeof r=="string"&&typeof v=="object"){var u={};if(v.color!==undefined){var t=Colors.decode(v.color);if(t){u.color=t}}$.each("background fill stroke width".split(" "),function(w,x){if(v[x]!==undefined){u[x]=v[x]}});if(!$.isEmptyObject(u)){m[r]=u}}return}if(arguments.length==1&&m[arguments[0]]!==undefined){s=m[arguments[0]]}if(s.width!==undefined){p.width=s.width}q.lineWidth=p.width;$.each("background fill stroke",function(y,x){if(s[x]!==undefined){if(s[x]===null){p[x]=null}else{var w=Colors.decode(s[x]);if(w){p[x]=w}}}});q.fillStyle=p.fill;q.strokeStyle=p.stroke},textStyle:function(s){if(arguments.length==0){return objcopy(g)}if(arguments.length==2){var r=arguments[0];var v=arguments[1];if(typeof r=="string"&&typeof v=="object"){var u={};if(v.color!==undefined){var t=Colors.decode(v.color);if(t){u.color=t}}$.each("font size align baseline alpha".split(" "),function(w,x){if(v[x]!==undefined){u[x]=v[x]}});if(!$.isEmptyObject(u)){b[r]=u}}return}if(arguments.length==1&&b[arguments[0]]!==undefined){s=b[arguments[0]]}if(s.font!==undefined){g.font=s.font}if(s.size!==undefined){g.size=s.size}q.font=nano("{size}px {font}",g);if(s.align!==undefined){q.textAlign=g.align=s.align}if(s.baseline!==undefined){q.textBaseline=g.baseline=s.baseline}if(s.alpha!==undefined){g.alpha=s.alpha}if(s.color!==undefined){var t=Colors.decode(s.color);if(t){g.color=t}}if(g.color){var t=Colors.blend(g.color,g.alpha);if(t){q.fillStyle=t}}},text:function(s,r,z,v){if(arguments.length>=3&&!isNaN(r)){v=v||{};v.x=r;v.y=z}else{if(arguments.length==2&&typeof(r)=="object"){v=r}else{v=v||{}}}var u=objmerge(g,v);q.save();if(u.align!==undefined){q.textAlign=u.align}if(u.baseline!==undefined){q.textBaseline=u.baseline}if(u.font!==undefined&&!isNaN(u.size)){q.font=nano("{size}px {font}",u)}var w=(u.alpha!==undefined)?u.alpha:g.alpha;var t=(u.color!==undefined)?u.color:g.color;q.fillStyle=Colors.blend(t,w);if(w>0){q.fillText(s,Math.round(u.x),u.y)}q.restore()},textWidth:function(r,t){t=objmerge(g,t||{});q.save();q.font=nano("{size}px {font}",t);var s=q.measureText(r).width;q.restore();return s},Rect:function(s,A,t,v,z,u){return new n(s,A,t,v,z,u)},rect:function(s,A,t,v,z,u){n.prototype._draw(s,A,t,v,z,u)},Oval:function(r,v,s,u,t){return new f(r,v,s,u,t)
},oval:function(r,v,s,u,t){t=t||{};f.prototype._draw(r,v,s,u,t)},line:function(s,v,r,t,u){var w=new a(s,v,r,t);w.draw(u)},lines:function(s,u,r,t){if(typeof t=="number"){k.push([{x:s,y:u},{x:r,y:t}])}else{k.push([s,u])}},drawLines:function(r){var s=new a(k);s.draw(r);k=[]}};return j.init()};arbor=(typeof(arbor)!=="undefined")?arbor:{};$.extend(arbor,{Graphics:function(ctx){return Graphics(ctx)},colors:{CSS:Colors.CSS,validate:Colors.validate,decode:Colors.decode,encode:Colors.encode,blend:Colors.blend}})})(this.jQuery);this.argunet=this.argunet||{};argunet.Argument=function(c,e,b,f,d,a){this.id=c;this.title=e;this.description=b;this.sentences=[];this.colorIndex=f;this.group=d;this.relations=a};argunet.Argument.prototype.addSentence=function(d,b,a){var c=new Sentence(d,b,a);this.sentences[b]=c};this.argunet=this.argunet||{};argunet.DebateManager=function(a){this.doc=$(a).get(0).ownerDocument;this.nodes={};this.colors=[];this.groups={};this.edgesBySource={};this.edgesByTarget={};var b=this;var c=argunet.DebateManager.prototype;c.addEventListener=null;c.removeEventListener=null;c.removeAllEventListeners=null;c.dispatchEvent=null;c.hasEventListener=null;c._listeners=null;createjs.EventDispatcher.initialize(c);this.loadDebate=function(e){var f=".graphml";if(e&&e.toLowerCase().indexOf(f,e.length-f.length)!==-1){this.loadGraphml(e)}else{var d;if(!e){d=$(a,this.doc).get(0)}else{d=$(e,this.doc).get(0)}if(d&&$(d).is(".argument-map")){this.parseHtml(d)}else{this.dispatchEvent({type:"error",textStatus:"Could not find argument map html."},this)}}};this.loadGraphml=function(d){console.log("loading graphml");$.ajax({type:"GET",url:d,dataType:"XML",success:function(e){var f;if(!window.DOMParser){f=new ActiveXObject("Microsoft.XMLDOM");f.async=false;f.loadXML(e)}else{f=e}f=$(e);b.parseGraphml(f)},error:function(e,g,f){this.dispatchEvent({type:"error",textStatus:g,errorThrown:f},this)}})};this.parseGraphml=function(e){var d=$(e).find("arg\\:debate, debate").get(0);this.debateTitle=$(d).children("arg\\:title").text();this.debateSubtitle=$(d).children("arg\\:subtitle").text();$(e).find("arg\\:color, color").each(function(){var h=$(this).attr("colorIndex");var f=$(this).attr("description");var g=$(this).attr("colorCode");b.colors[h]=b.getColorObject(h,f,g)});$(e).find("node").each(function(){if($(this).children("data:first").children("arg\\:group").length){var h=$(this).children("data:first").children("arg\\:group");var i=$(h).children("arg\\:title").text();var u=$(h).attr("numberOfArguments");var f=$(h).attr("numberOfTheses");var o=$(h).attr("color");var n=$(h).attr("id");var t=new argunet.Group(n,i,o,u,f);b.groups[n]=t}else{if($(this).children("data:first").children("arg\\:argument").length){var j=$(this).children("data:first").children("arg\\:argument:first");var v=$(j).attr("id");var q=$(j).children("arg\\:title").text();var s=$(j).children("arg\\:description").text();var r=$(j).attr("colorIndex");var p={incomingAttacks:$(j).attr("incomingAttacks"),incomingSupports:$(j).attr("incomingSupports"),outgoingAttacks:$(j).attr("outgoingAttacks"),outgoingSupports:$(j).attr("outgoingSupports")};var t;if($(this).parents("node:first").length){var n=$(this).parents("node:first").children("data:first").children("arg\\:group").attr("id");b.groups[n].addNode(v);t=n}var g=new argunet.Argument(v,q,s,r,t,p);b.nodes[v]=g}else{if($(this).children("data:first").children("arg\\:thesis").length){var l=$(this).children("data:first").children("arg\\:thesis:first");var v=$(l).attr("id");var q=$(l).children("arg\\:title").text();var k=$(l).children("arg\\:content").text();var r=$(l).attr("colorIndex");var t;var p={incomingAttacks:$(l).attr("incomingAttacks"),incomingSupports:$(l).attr("incomingSupports"),outgoingAttacks:$(l).attr("outgoingAttacks"),outgoingSupports:$(l).attr("outgoingSupports")};if($(this).parents("node:first").length){var n=$(this).parents("node:first").children("data:first").children("arg\\:group").attr("id");b.groups[n].addNode(v);t=n}var m=new argunet.Thesis(v,q,k,r,t,p);
b.nodes[v]=m}}}});$(e).find("edge:parent").each(function(){var g=$(this).children("data:first").children("arg\\:edge");var f=g.attr("type");b.addEdge($(g).attr("sourceNodeId"),$(g).attr("targetNodeId"),f,$(g).attr("sourcePropositionId"),$(g).attr("targetPropositionId"))});this.dispatchEvent({type:"debateLoaded"},this)};this.addEdge=function(g,h,f,d,e){edge=new argunet.Edge(g,h,f,d,e);if(this.edgesBySource[edge.source]==undefined){this.edgesBySource[edge.source]={}}if(this.edgesByTarget[edge.target]==undefined){this.edgesByTarget[edge.target]={}}this.edgesBySource[edge.source][edge.target]=edge;this.edgesByTarget[edge.target][edge.source]=edge;return edge};this.parseHtml=function(d){console.log("parsing html argument map");this.debateTitle=$(d).children("h3").text();this.debateSubtitle="";var f="#63aef2";this.colors[0]=this.getColorObject(0,"default 1",f);var e="#f2d863";this.colors[1]=this.getColorObject(1,"default 2",e);$(d).find(".argument, .thesis").each(function(){var m=$(this).attr("id");if(!m){this.dispatchEvent("error","Found node without id, which is a required attribute.",undefined);return}var k=$(this).children("h4")?$(this).children("h4").filter(":first").text():"Untitled";var i=$(this).children("p")?$(this).children("p").filter(":first").text():"";var l=b.lookupOrAddColor($(this).data("color"))||0;var j;var g={incomingAttacks:0,incomingSupports:0,outgoingAttacks:0,outgoingSupports:0};var h;if($(this).is(".argument")){h=new argunet.Argument(m,k,i,l,j,g)}else{h=new argunet.Thesis(m,k,i,l,j,g)}b.nodes[m]=h});$(d).find(".support, .attack").each(function(){var i=$(this).data("from");var h=$(this).data("to");var g=$(this).is(".support")?"support":"attack";b.addEdge(i,h,g)});this.dispatchEvent({type:"debateLoaded"},this)};this.lookupOrAddColor=function(d){var e;if(!d){return e}if(!(d!=d)){d=d.toString()}if(d.indexOf("#")==-1){return this.colors[d]?d:e}$(this.colors).each(function(){if(this.baseColor==d){e=this.index;return false}});if(!e){this.colors.push(this.getColorObject(this.colors.length,"",d));e=this.colors.length-1}return e};this.getColorObject=function(f,g,h){var e=$.xcolor.lighten(h,80,1).getHex();var d=$.xcolor.darken(h,45,3).getHex();return{index:f,description:g,base:h,light:e,dark:d}};this.getNode=function(d){return this.nodes[d]};this.getColor=function(d){return this.colors[d]};this.getEdge=function(e,d){return this.edgesBySource[e][d]};this.getEdgesFrom=function(d){return this.edgesBySource[d]};this.getEdgesTo=function(d){return this.edgesByTarget[d]}};this.argunet=this.argunet||{};argunet.Edge=function(e,c,d,a,b){this.source=e;this.target=c;this.sourceProposition=a;this.targetProposition=b;this.type=d};this.argunet=this.argunet||{};argunet.Group=function(e,d,a,b,c){this.id=e;this.title=d;this.color=a;this.numberOfArguments=parseInt(b);this.numberOfTheses=parseInt(c);this.nodes=[];this.open=true};argunet.Group.prototype.addNode=function(a){this.nodes.push(a)};this.argunet=this.argunet||{};argunet.HistoryState=function(a,b){this.type=a;this.data=b};this.argunet=this.argunet||{};argunet.Sentence=function(c,b,a){if(a!="conclusion"){a="premise"}this.text=c;this.nr=b;this.type=a};this.argunet=this.argunet||{};argunet.Thesis=function(c,e,b,f,d,a){this.id=c;this.argunetId=c;this.title=e;this.content=b;this.colorIndex=f;this.group=d;this.relations=a};this.argunet=this.argunet||{};(function(){var a=function(k,l,g){var d=argunet.ArborController.prototype;d.addEventListener=null;d.removeEventListener=null;d.removeAllEventListeners=null;d.dispatchEvent=null;d.hasEventListener=null;d._listeners=null;createjs.EventDispatcher.initialize(d);this.debateManager=l;this.arborView=k;var c={workerUrl:g,integrator:"euler",stiffness:400,repulsion:400,friction:0.7,gravity:true};this.sys=arbor.ParticleSystem(c);this.sys.parameters({integrator:"euler"});var f=new argunet.ArborConfigurator(this.sys,k.stage.canvas.width,k.stage.canvas.height);k.addEventListener("mousedown",this);this.sys.renderer=k;this.graphDepth=1;var h={};var e;var j={};
var i=undefined;this.doc=this.arborView.stage.canvas.ownerDocument;this.win="defaultView" in this.doc?this.doc.defaultView:this.doc.parentWindow;this.doc.addEventListener("fullscreenchange",this);this.doc.addEventListener("mozfullscreenchange",this);this.doc.addEventListener("webkitfullscreenchange",this);this.win.addEventListener("resize",this,false);this.addNodeToVisibleGraph=function(q,n){var p=(n==0)?true:false;groupId=this.debateManager.nodes[q].group;var o=(groupId)?!this.debateManager.groups[groupId].open:false;var m=false;if(h[q]!=undefined){if(p){h[q].selected=p}h[q].inactive=o;h[q].edgesToSelectedNode=Math.min(n,h[q].edgesToSelectedNode);return}else{if(!p&&(e&&!e.nodes[q])){m=true;this.nrOfNewNodes++}}this.nrOfNodes++;h[q]={id:q,isNew:m,selected:p,inactive:o,edgesToSelectedNode:n}};this.addEdgeToVisibleGraph=function(n){var o=n.source;var q=n.target;if(j[o]!=undefined&&j[o][q]!=undefined){return}if(j[o]==undefined){j[o]={}}var m=h[n.source];var p=h[n.target];var r=Math.max(m.edgesToSelectedNode,p.edgesToSelectedNode);j[o][q]={source:o,target:q,length:1/(r*r*r),sourceModel:n.source,targetModel:n.target}};this.changeGraphDepth=function(n,o){var m=this;if(n<o){$.each(h,function(p,r){var q=r;if(q.edgesToSelectedNode==n){if(m.debateManager.getEdgesTo(q.id)!=undefined){$.each(m.debateManager.getEdgesTo(q.id),function(s,t){m.addNodeToVisibleGraph(t.source,n+1);m.addEdgeToVisibleGraph(t)})}if(m.debateManager.getEdgesFrom(q.id)!=undefined){$.each(m.debateManager.getEdgesFrom(q.id),function(s,t){m.addNodeToVisibleGraph(t.target,n+1);m.addEdgeToVisibleGraph(t)})}m.changeGraphDepth(n+1,o)}})}else{return}};this.setGraphDepth=function(m){this.graphDepth=m;this.update()};this.selectNode=function(m){if(i==m){return}i=m;this.update()};this.update=function(){h={};j={};this.nrOfNodes=0;this.nrOfNewNodes=0;this.addNodeToVisibleGraph(i,0);this.changeGraphDepth(0,this.graphDepth);f.configurate(this.nrOfNodes,this.graphDepth,this.arborView.stage.canvas.width,this.arborView.stage.canvas.height);e={nodes:h,edges:j};var o=this.sys.getNode(i);var p=(o)?o.p.x:undefined;var n=(o)?o.p.y:undefined;console.log("x: "+p+" y: "+n);var m=this;this.sys.merge(e)}};var b=a.prototype;b.handleEvent=function(c){if(c.type=="historyChange"){var e=c.state;if(e.type=="nodeSelection"){this.selectNode(e.data.nodeId)}}else{if(c.type=="graphDepthChange"){this.graphDepth=c.value;this.update()}else{if(c.type=="openGroup"){this.debateManager.groups[c.id].open=true;this.update()}else{if(c.type=="closeGroup"){this.debateManager.groups[c.id].open=false;this.update()}else{if(c.type=="openAllGroups"){$.each(this.debateManager.groups,function(){this.open=true});this.update()}else{if(c.type=="closeAllGroups"){$.each(this.debateManager.groups,function(){this.open=false});this.update()}else{if(c.type=="resize"||c.type=="fullscreenchange"||c.type=="mozfullscreenchange"||c.type=="webkitfullscreenchange"){var d=this;if(this.doc.mozFullScreen||this.doc.webkitIsFullScreen){d.update();this.oldWidth=d.arborView.stage.canvas.width;this.oldHeight=d.arborView.stage.canvas.height}else{if(!this.oldWidth||!this.oldHeight||this.oldWidth!=d.arborView.stage.canvas.width||this.oldHeight!=d.arborView.stage.canvas.height){d.update();this.oldWidth=d.arborView.stage.canvas.width;this.oldHeight=d.arborView.stage.canvas.height}}}}}}}}}};argunet.ArborController=a}());this.argunet=this.argunet||{};(function(){var a=function(b){var c=b;this.configurate=function(e,g,i,d){var j=400;var h=400;var k=0.7;var l=Math.max(0,i-640)/(1440-640);console.log("repulsion: "+j+" stiffness: "+h+" friction: "+k);c.parameters({repulsion:j,stiffness:h,friction:k,gravity:true});c.screenSize(i,d)}};argunet.ArborConfigurator=a}());this.argunet=this.argunet||{};argunet.BrowserRegistry=function(a){if(arguments.callee.instance){return arguments.callee.instance}arguments.callee.instance=this;this.w=a;this.w.argunet=a.argunet||{};this.w.argunet.browsers=a.argunet.browsers||[];var b=function(){var c=[];var d=/.*ArgunetBrowser\.load\.([^/]+\.)?js/;
$("script",a.document).each(function(){if($(this).attr("src")&&$(this).attr("src").match(d)){c.push(this)}});return c};a.argunet.scriptTags=a.argunet.scriptTags||b();this.browsers=[];this.registerBrowser=function(c){this.w.argunet.browsers.push(c);return this.w.argunet.browsers.length};this.getScriptTag=function(c){return this.w.argunet.scriptTags[c-1]}};argunet.BrowserRegistry.getInstance=function(b){var a=new argunet.BrowserRegistry(b);return a};this.argunet=this.argunet||{};(function(){var a=function(c,d){this.view=c;this.manager=d;var e=this;var b={};var g=[];var f=function(l,i){var h=e.manager.getNode(l);var k="";if(h instanceof argunet.Argument){k="Argument: "+h.title}else{if(h instanceof argunet.Thesis){k="Thesis: "+h.title}}var j={name:k,nodeId:h.id,nocheck:true};if(i!=undefined){i.children.push(j);b[l]=true}else{g.push(j)}};$.each(this.manager.groups,function(){var h={id:this.id,name:"Group: "+this.title,children:[],checked:false};$.each(this.nodes,function(){f(this,h)});g.push(h)});$.each(this.manager.nodes,function(){if(!b[this.id]){f(this.id)}});this.view.initialize(this.manager.debateTitle,this.manager.debateSubtitle,g)};argunet.DebateListController=a}());this.argunet=this.argunet||{};argunet.History=function(){var b=argunet.History.prototype;b.addEventListener=null;b.removeEventListener=null;b.removeAllEventListeners=null;b.dispatchEvent=null;b.hasEventListener=null;b._listeners=null;createjs.EventDispatcher.initialize(b);var c=-1;var a=[];this.backwardEnabled=false;this.forwardEnabled=false;this.homeEnabled=false;this.addState=function(d){if(!d instanceof argunet.HistoryState){throw new Error("'state' is not an instance of argunet.HistoryState");return}c++;if(c<a.length-1){a.splice(c,a.length-c-1,d);this.forwardEnabled=false}else{a[c]=d}if(a.length>1){this.backwardEnabled=true}if(c==0){this.homeEnabled=false}else{this.homeEnabled=true}this.dispatchEvent({type:"historyChange",state:this.getCurrentState()},this)};this.back=function(){if(!this.backwardEnabled){return}if(c>0){c--;this.forwardEnabled=true}if(c==0){this.backwardEnabled=false;this.homeEnabled=false}else{this.homeEnabled=true}this.dispatchEvent({type:"historyChange",state:this.getCurrentState()},this)};this.forward=function(){if(!this.forwardEnabled){return}if(c<a.length-1){c++;this.backwardEnabled=true;this.homeEnabled=true}if(c==a.length-1){this.forwardEnabled=false}this.dispatchEvent({type:"historyChange",state:this.getCurrentState()},this)};this.home=function(){if(!this.homeEnabled){return}c=0;this.backwardEnabled=false;this.homeEnabled=false;if(a.length>0){this.forwardEnabled=true}this.dispatchEvent({type:"historyChange",state:this.getCurrentState()},this)};this.getCurrentState=function(){return a[c]};this.selectNode=function(d){if(this.selectedNode!=undefined&&this.selectedNode==d){return}this.selectedNode=d;this.addState(new argunet.HistoryState("nodeSelection",{nodeId:d}))};this.handleEvent=function(d){if(d.type=="back"){this.back()}else{if(d.type=="home"){this.home()}else{if(d.type=="forward"){this.forward()}}}}};this.argunet=this.argunet||{};(function(){var a=function(){};var b=a.prototype=new createjs.Container();b.Container_initialize=a.prototype.initialize;b.Container_tick=a.prototype._tick;b.initialize=function(g,f,e,c){this.Container_initialize();this.nodeId=g;this.colors=c;this.title=f;this.text=e;this.state0Height=15;this.cornerRadius=8;this.styleState1={width:100,bgColor:this.colors.base,borderColor:this.colors.dark,borderWidth:1,cornerRadius:8,titleColor:this.colors.dark,titleCss:"11px Arial",textColor:this.colors.dark};this.styleState2={width:140,bgColor:this.colors.base,borderColor:this.colors.dark,borderWidth:3,cornerRadius:8,titleColor:this.colors.dark,titleCss:"bold 11px Arial",textColor:this.colors.dark,textCss:"11px Arial"};this.styleState0={cornerRadius:8};this.paddingState1={top:4,left:4,bottom:4,right:4};this.paddingState2={top:8,left:8,bottom:8,right:8};this.marginState1={top:1,right:1,bottom:1,left:1};this.marginState2={top:2,right:2,bottom:2,left:2};
var d=this;this.addEventListener("mousedown",this)};b.handleEvent=function(c){if(c.type=="mousedown"){this.lastMousedown=new Date().getTime();var d=this;c.onMouseMove=function(e){e.target.x=e.stageX;e.target.y=e.stageY;d.dispatchEvent("drag",d)};c.onMouseUp=function(e){var f=new Date().getTime();if(f-d.lastMousedown<200){d.dispatchEvent("select",d)}d.dispatchEvent("drop",d)}}};b.render=function(){this.state0=new createjs.Container();this.state0inactive=new createjs.Container();this.state1=new createjs.Container();this.state2=new createjs.Container();this.addChild(this.state0);this.addChild(this.state0inactive);this.addChild(this.state1);this.addChild(this.state2);var h=new createjs.Graphics();h.beginFill(this.styleState1.bgColor);h.setStrokeStyle(this.styleState1.borderWidth).beginStroke(this.styleState1.borderColor);h.drawRoundRect(0,0,this.state0Height,this.state0Height,this.styleState0.cornerRadius);var f=new createjs.Shape(h);f.x=-this.state0Height/2;f.y=-this.state0Height/2;this.state0.addChild(f);var e="#dddddd";var h=new createjs.Graphics();h.beginFill(e);h.setStrokeStyle(this.styleState1.borderWidth).beginStroke("#bbbbbb");h.drawRoundRect(0,0,this.state0Height,this.state0Height,this.styleState0.cornerRadius);var g=new createjs.Shape(h);g.x=-this.state0Height/2;g.y=-this.state0Height/2;this.state0inactive.addChild(g);var c=new createjs.Text(this.shortenWords(this.title,17,"."),this.styleState1.titleCss,this.styleState1.titleColor);c.lineWidth=this.styleState1.width-this.paddingState1.left-this.paddingState1.right;c.textAlign="center";this.state1Height=c.getMeasuredHeight()+this.paddingState1.top+this.paddingState1.bottom;var h=new createjs.Graphics();h.beginFill(this.styleState1.bgColor);h.setStrokeStyle(this.styleState1.borderWidth).beginStroke(this.styleState1.borderColor);h.drawRoundRect(0,0,this.styleState1.width,this.state1Height,this.styleState2.cornerRadius);var d=new createjs.Shape(h);d.x=-this.styleState1.width/2;d.y=-this.state1Height/2;this.state1.addChild(d);c.x=d.x+this.styleState1.width/2;c.y=d.y+this.paddingState1.top;this.state1.addChild(c);this.renderState2();this.deselect()};b.shortenString=function(e,d,c){return(e.length>d)?e.substring(0,e.length-(e.length-d))+c:e};b.shortenWords=function(h,d,c){var f="";var g=h.split(" ");var e=this;$.each(g,function(j,m){var k=m;if(m.length>d){hyphenIndex=m.indexOf("-");slashIndex=m.indexOf("/");if((-1<hyphenIndex&&hyphenIndex<m.length-1)||(-1<slashIndex&&slashIndex<m.length-1)){k=e.shortenWords(m.replace("-","- ").replace("/","/ "),d,c)}else{k=e.shortenString(m,d,c)}}var l=(f=="")?"":" ";f+=l+k});return f};b.renderState2=function(){this.state2Height=this.paddingState2.top+this.paddingState2.bottom;if(this.title!=""&&this.title.toLowerCase()!="untitled"){var g=new createjs.Text(this.shortenWords(this.title,24,"."),this.styleState2.titleCss,this.styleState2.titleColor);g.lineWidth=this.styleState2.width-this.paddingState2.left-this.paddingState2.right;g.textAlign="center";this.state2Height+=g.getMeasuredHeight()}if(this.text!=""){var d=this.shortenWords(this.shortenString(this.text,200,"."),24," ...");var f=new createjs.Text(d,this.styleState2.textCss,this.styleState2.textColor);f.lineWidth=this.styleState2.width-this.paddingState2.left-this.paddingState2.right;f.textAlign="center";this.state2Height+=f.getMeasuredHeight();if(g){this.state2Height+=this.paddingState2.top/2}}var e=new createjs.Graphics();e.beginFill(this.styleState2.bgColor);e.setStrokeStyle(this.styleState2.borderWidth).beginStroke(this.styleState2.borderColor);e.drawRoundRect(0,0,this.styleState2.width,this.state2Height,this.styleState2.cornerRadius);var c=new createjs.Shape(e);c.x=-this.styleState2.width/2;c.y=-this.state2Height/2;this.state2.addChild(c);if(g){g.x=c.x+this.styleState2.width/2;g.y=c.y+this.paddingState2.top;this.state2.addChild(g)}if(f){f.x=c.x+this.styleState2.width/2;f.y=c.y+this.state2Height-f.getMeasuredHeight()-this.paddingState2.bottom;this.state2.addChild(f)}};b.getMarginedHeight=function(){if(this.state1.visible){return this.state1Height+this.marginState1.top+this.marginState1.bottom
}else{if(this.state2.visible){return this.state2Height+this.marginState2.top+this.marginState2.bottom}else{return this.state0Height}}};b.getMarginedWidth=function(){if(this.state1.visible){return this.styleState1.width+this.marginState1.top+this.marginState1.bottom}else{if(this.state2.visible){return this.styleState2.width+this.marginState1.left+this.marginState1.right}else{return this.state0Height}}};b.select=function(){this.state0.visible=false;this.state0inactive.visible=false;this.state1.visible=false;this.state2.visible=true};b.deselect=function(){this.state0.visible=false;this.state0inactive.visible=false;this.state1.visible=true;this.state2.visible=false};b.minimize=function(c){this.state1.visible=false;this.state2.visible=false;if(!c){this.state0.visible=true;this.state0inactive.visible=false}else{this.state0.visible=false;this.state0inactive.visible=true}};b._tick=function(){};argunet.SelectableView=a}());this.argunet=this.argunet||{};argunet.ArgunetBrowserView=function(g,c,a,f){var e=this;this.canvasView=undefined;this.height100Percent=false;if(a&&a=="100%"){a=$(g).innerHeight();this.height100Percent=true}this.cWidth=c;this.cHeight=a||385;this.cHeight-=2;var b="argunetBrowser-"+f;this.htmlElement=$("<div id='"+b+"' class='argunetBrowser loading'></div>").appendTo(g).get(0);if(this.cWidth){this.cWidth-=2;$(this.htmlElement).width(this.cWidth)}else{this.cWidth=$(this.htmlElement).width()}this.canvas=$("<canvas></canvas>").appendTo(this.htmlElement).get(0);$(this.canvas).width(this.cWidth).height(this.cHeight);this.canvas.width=this.cWidth;this.canvas.height=this.cHeight;this.doc=this.canvas.ownerDocument;this.win="defaultView" in this.doc?this.doc.defaultView:this.doc.parentWindow;this.stage=new createjs.Stage(this.canvas);this.stage.mouseEventsEnabled=true;this.stage.enableMouseOver(20);if(createjs.Touch.isSupported()){createjs.Touch.enable(this.stage)}this.navigationBar=new argunet.NavigationBarView($(this.canvas).parent());this.navigationOpened=false;this.debateListView=new argunet.DebateListView($(this.canvas).parent(),f);console.log("naviHeight "+this.navigationBar.height);var d=new createjs.Container();this.stage.addChild(d);this.tooltip=new argunet.TooltipCanvasView(this.canvas);this.stage.addChild(this.tooltip);var e=this;$(this.canvas).parent().bind("mousedown touchstart",function(){e.showNavigationBar()});this.resize()};argunet.ArgunetBrowserView.prototype.showNavigationBar=function(){window.clearTimeout(this.navigationBarTimeout);if(!this.navigationOpened){this.navigationBar.show();this.navigationOpened=true}var a=this;this.navigationBarTimeout=window.setTimeout(function(){if(a.navigationOpened&&!a.debateListView.isOpen&&a.stage.mouseY<a.canvas.height-a.navigationBar.height){a.navigationBar.hide();a.navigationOpened=false}window.clearTimeout(a.navigationBarTimeout)},3500)};argunet.ArgunetBrowserView.prototype.handleEvent=function(b){var e=this;if(b.type=="showTooltip"){this.tooltipTimeout=window.setTimeout(function(){e.tooltip.setContent(b.tooltip);e.tooltip.setVisible(true);e.tooltip.x=Math.min($(e.stage.canvas).outerWidth()-5-e.tooltip.getWidth(),e.stage.mouseX+5);e.tooltip.y=Math.min(e.stage.canvas.height-5-e.tooltip.height,e.stage.mouseY+5);e.stage.update();window.clearTimeout(this.tooltipTimeout)},1000)}else{if(b.type=="hideTooltip"&&!this.mouseOverTooltip){window.clearTimeout(this.tooltipTimeout);this.tooltip.setVisible(false);this.stage.update()}else{if(b.type=="mousedown"){if(!this.mouseOverTooltip){window.clearTimeout(this.tooltipTimeout);this.tooltip.setVisible(false);this.stage.update()}}else{if(b.type=="mouseover"&&b.target==this.tooltip){this.mouseOverTooltip=true}else{if(b.type=="mouseout"&&b.target==this.tooltip){this.mouseOverTooltip=false;this.tooltip.setVisible(false);this.stage.update()}else{if(b.type=="stagemousemove"){this.showNavigationBar()}else{if(b.type=="openDebateList"){this.debateListView.show()}else{if(b.type=="closeDebateList"){this.debateListView.hide();this.showNavigationBar()}else{if(b.type=="openFullscreen"){var f=$(this.canvas).parent().get(0);
var a=f.requestFullscreen||f.webkitRequestFullscreen||f.mozRequestFullScreen;if(a){a.call(f)}}else{if(b.type=="closeFullscreen"){var a=this.doc.exitFullscreen||this.doc.webkitExitFullscreen||this.doc.mozCancelFullScreen;if(a){a.call(this.doc)}}else{if(b.type=="resize"||b.type=="fullscreenchange"||b.type=="mozfullscreenchange"||b.type=="webkitfullscreenchange"){var g=this.canvas;if(this.doc.mozFullScreen||this.doc.webkitIsFullScreen){var d=g.getBoundingClientRect();$(g).width(d.width);$(g).height(d.height);this.canvas.width=d.width;this.canvas.height=d.height}else{if(this.oldWidth&&this.oldHeight&&this.oldWidth==$(this.htmlElement).innerWidth()&&this.oldHeight==$(this.htmlElement).parent().innerHeight-2){return}this.resize()}}}}}}}}}}}}};argunet.ArgunetBrowserView.prototype.resize=function(){this.cWidth=$(this.htmlElement).innerWidth();if(this.height100Percent){this.cHeight=$(this.htmlElement).parent().innerHeight()-2}if(this.cWidth<450){this.debateListView.setHeight(this.cHeight-100+2)}else{this.debateListView.setHeight(this.cHeight-50+2)}$(this.canvas).width(this.cWidth);$(this.canvas).height(this.cHeight);this.canvas.width=this.cWidth;this.canvas.height=this.cHeight;this.oldWidth=this.canvas.width;this.oldHeight=this.canvas.height};argunet.ArgunetBrowserView.prototype.setCanvasView=function(a){var b=this;this.stage.clear();this.canvasView=a;this.canvasView.initialize(this.stage);this.tooltip.addEventListener("mouseover",this);this.tooltip.addEventListener("mouseout",this);this.stage.addEventListener("stagemousemove",this);this.navigationBar.addEventListener("openDebateList",this);this.navigationBar.addEventListener("closeDebateList",this);this.doc.addEventListener("fullscreenchange",this);this.doc.addEventListener("mozfullscreenchange",this);this.doc.addEventListener("webkitfullscreenchange",this);this.win.addEventListener("resize",this,false);this.navigationBar.addEventListener("openFullscreen",this);this.navigationBar.addEventListener("closeFullscreen",this)};argunet.ArgunetBrowserView.prototype.removeLoadingSpinner=function(){$(this.canvas).parent().removeClass("loading")};this.argunet=this.argunet||{};(function(){var a=function(b,c,d){this.initialize(b,c,d)};a.prototype=new createjs.Container();a.prototype.Container_initialize=a.prototype.initialize;a.prototype.Container_tick=a.prototype._tick;a.prototype.initialize=function(b,c,d){this.Container_initialize();this.color=(b.type==undefined||b.type.toLowerCase()=="attack"||b.type.toLowerCase()=="sketchedattack")?"#D9000E":"#54BC11";this.edge=b;this.source=c;this.target=d};a.prototype.render=function(r,s){this.removeAllChildren();var m=18;var k=5;var q=5;var i=1;var h=Math.atan2(s.y-r.y,s.x-r.x);var f=h*(180/Math.PI);var p=s.x-r.x;var o=s.y-r.y;var n=Math.sqrt(p*p+o*o);n=n-m+q;var d=n*Math.cos(h);var u=n*Math.sin(h);d+=r.x;u+=r.y;var l=new createjs.Graphics();l.setStrokeStyle(i).beginStroke(this.color).moveTo(r.x,r.y).lineTo(d,u).endStroke();var j=new createjs.Shape(l);this.addChild(j);var t=new createjs.Graphics();t.beginFill(this.color).moveTo(-m,k).lineTo(0,0).lineTo(-m,-k).lineTo(-m+q,-0).closePath().endFill();var e=new createjs.Shape(t);e.x=s.x;e.y=s.y;e.rotation=f;this.addChild(e)};a.prototype._tick=function(){};argunet.ArrowCanvasView=a}());this.argunet=this.argunet||{};(function(){var a=function(d,c){this.initialize(d,c)};var b=a.prototype=new argunet.SelectableView();b.Selectable_initialize=a.prototype.initialize;b.Selectable_tick=a.prototype._tick;b.initialize=function(d,c){this.Selectable_initialize(d.id,d.title,d.description,c);this.argument=d;this.render()};argunet.ArgumentCanvasView=a}());this.argunet=this.argunet||{};(function(){var a=function(d,c){this.initialize(d,c)};var b=a.prototype=new argunet.SelectableView();b.Selectable_initialize=a.prototype.initialize;b.Selectable_tick=a.prototype._tick;b.initialize=function(d,c){this.Selectable_initialize(d.id,d.title,d.content,c);this.thesis=d;this.styleState1.borderColor=this.styleState2.borderColor=this.colors.base;
this.styleState1.borderWidth=2;this.styleState2.borderWidth=4;this.styleState1.bgColor=this.styleState2.bgColor="#ffffff";this.styleState1.textColor=this.styleState2.textColor=this.styleState1.titleColor=this.styleState2.titleColor="#000000";this.marginState1.top=this.marginState1.right=this.marginState1.bottom=this.marginState1.left=1;this.marginState2.top=this.marginState2.right=this.marginState2.bottom=this.marginState2.left=2;this.render()};argunet.ThesisCanvasView=a}());this.argunet=this.argunet||{};argunet.ArborView=function(a){var k=a;var b=argunet.ArborView.prototype;b.addEventListener=null;b.removeEventListener=null;b.removeAllEventListeners=null;b.dispatchEvent=null;b.hasEventListener=null;b._listeners=null;createjs.EventDispatcher.initialize(b);var i=null;this.stage;var h={};var d={};var g=undefined;var c=undefined;var j=undefined;this.initialize=function(l){this.stage=l;j=new createjs.Container();this.stage.addChild(j);c=new createjs.Container();this.stage.addChild(c)};this.init=function(l){i=l;i.screenSize(this.stage.canvas.width,this.stage.canvas.height);i.screenPadding(40)};this.handleEvent=function(l){var r=this.stage.canvas.ownerDocument;if(l.type=="select"){this.dispatchEvent({type:"nodeSelection",nodeId:l.target.nodeId},l.target)}else{if(l.type=="mouseover"){r.body.style.cursor="pointer";var s="<h3>"+l.target.title+"</h3><p>"+l.target.text+"</p>";var m;if(l.target instanceof argunet.ArgumentCanvasView||l.target instanceof argunet.ThesisCanvasView){if(l.target instanceof argunet.ArgumentCanvasView){m=l.target.argument}else{m=l.target.thesis}s+="<table class='relations'><tr><td class='incoming-attacks'><span class='icon-incoming-attacks'></span><span class='label'>"+m.relations.incomingAttacks+"</span></td><td class='incoming-supports'><span class='icon-incoming-supports'></span><span class='label'>"+m.relations.incomingSupports+"</span></td></tr><tr><td class='outgoing-attacks'><span class='icon-outgoing-attacks'></span><span class='label'>"+m.relations.outgoingAttacks+"</span></td><td class='outgoing-supports'><span class='icon-outgoing-supports'></span><span class='label'>"+m.relations.outgoingSupports+"</span></td></tr></table>"}else{if(l.target instanceof argunet.GroupCanvasView){if(l.target.state2.visible){s+="<p class='tip'>(double click group to open the group and show its members.)</p>"}}}this.dispatchEvent({type:"showTooltip",tooltip:s},l.target)}else{if(l.type=="mouseout"){r.body.style.cursor="default";this.dispatchEvent("hideTooltip",l.target)}else{if(l.type=="mousedown"){this.dispatchEvent({type:"mousedown",nodeId:l.target.nodeId},l.target)}else{if(l.type=="drag"){r.body.style.cursor="move";var o=l.target;var n=i.getNode(l.target.nodeId);n.fixed=true;var q={x:o.x,y:o.y};q=i.fromScreen(q);n.p=q}else{if(l.type=="drop"){r.body.style.cursor="default";var o=l.target;var n=i.getNode(l.target.nodeId);n.fixed=false;n.tempMass=50}else{if(l.type=="dblclick"){this.dispatchEvent(l,l.target)}}}}}}}};this.selectNode=function(l){if(g!=undefined){g.deselect()}g=h[l];g.select()};this.redraw=function(){var m=this;if(!i){return}$.each(h,function(){var o=this.nodeId;if(i.getNode(o)==undefined){var n=h[o];if(g!=undefined&&n.nodeId==g.nodeId){g=undefined}n.removeEventListener(m);c.removeChild(n);delete h[o]}});$.each(d,function(){$.each(this,function(){if(i.getEdgesFrom(this.source)[this.target]==undefined){var n=d[this.source][this.target];j.removeChild(n);delete d[this.source][this.target]}})});var l={};i.eachNode(function(o,r){var q=h[o.data.id];if(h[o.data.id]==undefined){var s;s=k.getNode(o.data.id);if(s instanceof argunet.Argument){q=new argunet.ArgumentCanvasView(s,k.getColor(s.colorIndex))}else{if(s instanceof argunet.Thesis){q=new argunet.ThesisCanvasView(s,k.getColor(s.colorIndex))}}q.addEventListener("select",m);q.addEventListener("mousedown",m);q.addEventListener("dblclick",m);q.addEventListener("mouseover",m);q.addEventListener("mouseout",m);q.addEventListener("drag",m);q.addEventListener("drop",m);h[o.data.id]=q;
c.addChild(q)}var q=h[o.data.id];r.x=Math.floor(r.x);r.y=Math.floor(r.y);q.x=r.x;q.y=r.y;var n=q.getMarginedWidth();var p=q.getMarginedHeight();l[o.data.id]=[r.x-n/2,r.y-p/2,n,p];if(o.data.selected&&!o.data.inactive){m.selectNode(o.data.id)}else{if(o.data.inactive){q.minimize(true)}else{if(o.data.edgesToSelectedNode>1){q.minimize(false)}else{if(o.data.edgesToSelectedNode>0&&!o.data.inactive){q.deselect()}}}}});i.eachEdge(function(o,r,q){var n=l[o.data.target];var u={x:r.x,y:r.y};var t=f(u,q,n);var s=(d[o.data.source])?d[o.data.source][o.data.target]:undefined;if(s==undefined){if(d[o.data.source]==undefined){d[o.data.source]={}}var p=k.getEdge(o.data.sourceModel,o.data.targetModel);var s=new argunet.ArrowCanvasView(p,o.data.source,o.data.target);d[o.data.source][o.data.target]=s;j.addChild(s)}s.render(u,t)});this.stage.update()};var e=function(r,q,p,o){var l=((o.y-p.y)*(q.x-r.x)-(o.x-p.x)*(q.y-r.y));if(l===0){return false}var n=((o.x-p.x)*(r.y-p.y)-(o.y-p.y)*(r.x-p.x))/l;var m=((q.x-r.x)*(r.y-p.y)-(q.y-r.y)*(r.x-p.x))/l;if(n<0||n>1||m<0||m>1){return false}return arbor.Point(r.x+n*(q.x-r.x),r.y+n*(q.y-r.y))};var f=function(s,r,l){var p={x:l[0],y:l[1]},q=l[2],n=l[3];var u={x:p.x,y:p.y};var o={x:p.x+q,y:p.y};var m={x:p.x,y:p.y+n};var t={x:p.x+q,y:p.y+n};return e(s,r,u,o)||e(s,r,o,t)||e(s,r,t,m)||e(s,r,m,u)||false}};this.argunet=this.argunet||{};(function(){var a=function(c){this.initialize(c)};var b=a.prototype=new createjs.Container();b.Container_initialize=a.prototype.initialize;b.Container_tick=a.prototype._tick;b.initialize=function(c){this.Container_initialize();$(c).parent().append("<div class='argunet-tooltip'>Dies ist ein Tooltip</div>");this.tooltip=$(c).parent().children(".argunet-tooltip").get(0);var e=new createjs.DOMElement(this.tooltip);this.addChild(e);this.x=50;this.y=50;this.setVisible(false);var d=this;$(this.tooltip).mouseenter(function(f){d.dispatchEvent("mouseover",d)});$(this.tooltip).mouseleave(function(f){d.dispatchEvent("mouseout",d)})};b.getWidth=function(){return $(this.tooltip).outerWidth()};b.setContent=function(c){$(this.tooltip).empty();$(this.tooltip).append(c);this.height=$(this.tooltip).outerHeight()};b.setVisible=function(c){if(c){this.visible=true;$(this.tooltip).show()}else{this.visible=false;$(this.tooltip).hide()}};b._tick=function(){this.Container_tick()};argunet.TooltipCanvasView=a}());this.argunet=this.argunet||{};argunet.NavigationBarView=function(d){var b=argunet.NavigationBarView.prototype;b.addEventListener=null;b.removeEventListener=null;b.removeAllEventListeners=null;b.dispatchEvent=null;b.hasEventListener=null;b._listeners=null;createjs.EventDispatcher.initialize(b);var g="Open Debate List";this.fullscreenApiImplemented=false;var e=typeof d.get(0).requestFullscreen=="function"||typeof d.get(0).webkitRequestFullscreen=="function"||typeof d.get(0).mozRequestFullScreen=="function";var i=typeof document.exitFullscreen=="function"||typeof document.webkitExitFullscreen=="function"||typeof document.mozCancelFullScreen=="function";var h=document.fullScreen!=undefined||document.webkitIsFullScreen!=undefined||document.mozFullScreen!=undefined;if(e&&i&&h){this.fullscreenApiImplemented=true}var c="";if(this.fullscreenApiImplemented){c="<div class='fullscreen menuItem'>Fullscreen</div>"}$(d).append("<div class='navigationBar'><div class='menu'><div class='back menuItem'>Back</div><div class='home menuItem'>Home</div><div class='forward menuItem'>Forward</div><div class='openList menuItem'>"+g+"</div><div class='decreaseDepth menuItem'>Decrease Depth</div><div class='graphDepth menuItem'><div class='label'>Graph Depth: <span class='graphDepthLabel'>1</span></div><div class='slider'></div></div><div class='increaseDepth menuItem'>Increase Depth</div>"+c+"</div><a href='http://www.argunet.org' class='logo'><span>Argunet</span></a></div>");this.htmlElement=$(d).children(".navigationBar").get(0);this.doc=this.htmlElement.ownerDocument;this.win="defaultView" in this.doc?this.doc.defaultView:this.doc.parentWindow;
var f=this;var a=$(this.htmlElement).find(".graphDepth .slider");$(a,this.doc).slider({min:1,max:5,change:function(j,k){f.dispatchEvent({type:"graphDepthChange",value:k.value},f)}},this.doc);$(this.htmlElement).find(".buttons").buttonset();openListButton=$(this.htmlElement).find(".openList");openListButton.button().click(function(){var j=$(this).button("option","label");if(j==g){$(this).button("option","label","Close Debate List");f.dispatchEvent({type:"openDebateList"},f)}else{$(this).button("option","label",g);f.dispatchEvent({type:"closeDebateList"},f)}});$(this.htmlElement).find(".back").button({icons:{primary:"ui-icon-circle-triangle-w"},text:false}).click(function(){f.dispatchEvent({type:"back"},f)});$(this.htmlElement).find(".home").button({icons:{primary:"ui-icon-home"},text:false}).click(function(){f.dispatchEvent({type:"home"},f)});$(this.htmlElement).find(".forward").button({icons:{primary:"ui-icon-circle-triangle-e"},text:false}).click(function(){f.dispatchEvent({type:"forward"},f)});$(this.htmlElement).find(".decreaseDepth").button({icons:{primary:"ui-icon-circle-minus"},text:false}).click(function(){a.slider("value",a.slider("value")-1)});$(this.htmlElement).find(".increaseDepth").button({icons:{primary:"ui-icon-circle-plus"},text:false}).click(function(){a.slider("value",a.slider("value")+1)});if(this.fullscreenApiImplemented){this.fullscreenLabel="Fullscreen";this.exitFullscreenLabel="Exit Fullscreen";this.fullscreenButton=$(this.htmlElement).find(".fullscreen");this.fullscreenButton.button({icons:{primary:"ui-icon-open-fullscreen"},text:false}).click(function(){var j=$(this).button("option","label");if(j==f.fullscreenLabel){f.dispatchEvent({type:"openFullscreen"},f)}else{f.dispatchEvent({type:"closeFullscreen"},f)}})}this.height=$(this.htmlElement).height();this.doc.addEventListener("fullscreenchange",this);this.doc.addEventListener("mozfullscreenchange",this);this.doc.addEventListener("webkitfullscreenchange",this);this.win.addEventListener("resize",this,false);this.updateHeight();$(this.htmlElement,this.doc).hide()};argunet.NavigationBarView.prototype.handleEvent=function(a){if(a.type=="fullscreenchange"||a.type=="mozfullscreenchange"||a.type=="webkitfullscreenchange"){if(this.doc.fullScreen||this.doc.webkitIsFullScreen||this.doc.mozFullScreen){this.fullscreenButton.button("option","label",this.exitFullscreenLabel);this.fullscreenButton.button("option","icons",{primary:"ui-icon-exit-fullscreen"})}else{this.fullscreenButton.button("option","label",this.fullscreenLabel);this.fullscreenButton.button("option","icons",{primary:"ui-icon-open-fullscreen"})}}else{if(a.type=="resize"){this.updateHeight()}else{if(a.type=="graphDepthChange"){$(this.htmlElement).find(".graphDepthLabel").text(a.value);var b=$(this.htmlElement).find(".slider");if($(b).slider("value")!=a.value){$(b).slider("value",a.value)}}}}};argunet.NavigationBarView.prototype.updateHeight=function(){var a=$(this.htmlElement).width();if(a>580){$(this.htmlElement).children(".logo").show()}else{if(a<580&&a>450){$(this.htmlElement).css("height","50px");$(this.htmlElement).children(".logo").hide()}else{$(this.htmlElement).children(".logo").hide();$(this.htmlElement).css("height","100px")}}};argunet.NavigationBarView.prototype.show=function(){$(this.htmlElement).show("slide",{direction:"down"},600)};argunet.NavigationBarView.prototype.hide=function(){$(this.htmlElement).hide("slide",{direction:"down"},600)};argunet.NavigationBarView.prototype.setBackwardEnabled=function(a){$(this.htmlElement).find(".back").button({disabled:!a})};argunet.NavigationBarView.prototype.setForwardEnabled=function(a){$(this.htmlElement).find(".forward").button({disabled:!a})};argunet.NavigationBarView.prototype.setHomeEnabled=function(a){$(this.htmlElement).find(".home").button({disabled:!a})};this.argunet=this.argunet||{};argunet.DebateListView=function(d,c){var b=argunet.DebateListView.prototype;b.addEventListener=null;b.removeEventListener=null;b.removeAllEventListeners=null;b.dispatchEvent=null;
b.hasEventListener=null;b._listeners=null;createjs.EventDispatcher.initialize(b);this.zTreeId="argunetBrowser"+c+"-ztree";d.append("<div class='debateList'><div id='"+this.zTreeId+"' class='tree ztree'></div></div>");this.htmlElement=$(d).children(".debateList").get(0);var a=this;$(this.htmlElement).hide()};argunet.DebateListView.prototype.initialize=function(f,b,e){if(b){$(this.htmlElement).prepend("<h4>"+b+"</h4>")}$(this.htmlElement).prepend("<h3>"+f+"</h3>");$(this.htmlElement).hide();var d=this;var c=function(h,j,i){if(i.nodeId!=undefined){d.dispatchEvent({type:"nodeSelection",nodeId:i.nodeId},d)}};var g=function(h,j,i){if(i.checked){d.dispatchEvent({type:"openGroup",id:i.id},this)}else{d.dispatchEvent({type:"closeGroup",id:i.id},this)}};var a={callback:{onClick:c,onCheck:g},check:{enable:false,chkboxType:{Y:"ps",N:"ps"}}};this.zTree=$.fn.zTree.init($(this.htmlElement).children("#"+this.zTreeId),a,e)};argunet.DebateListView.prototype.setHeight=function(a){this.height=a;$(this.htmlElement).height(this.height)};argunet.DebateListView.prototype.show=function(){$(this.htmlElement).show("slide",{direction:"left"},600);this.isOpen=true};argunet.DebateListView.prototype.hide=function(){$(this.htmlElement).hide("slide",{direction:"left"},600);this.isOpen=false};this.argunet=this.argunet||{};(function(){var b=function(c){this.initialize(c)};var a=b.prototype=new argunet.SelectableView();a.Selectable_initialize=b.prototype.initialize;a.Selectable_tick=b.prototype._tick;a.initialize=function(d){var c=d.numberOfArguments+d.numberOfTheses;this.Selectable_initialize(d.id,"Group: "+d.title,c+" Members",{base:d.color,dark:"#666",light:d.color});this.group=d;this.styleState2.textCss="bold 18px Arial";this.styleState2.borderWidth=1;this.styleState1.borderWidth=1;this.styleState1.cornerRadius=20;this.styleState2.cornerRadius=35;this.styleState0.cornerRadius=10;this.state0Height=25;this.paddingState1={top:12,left:12,bottom:12,right:12};this.paddingState2={top:20,left:20,bottom:20,right:20};this.render()};argunet.GroupCanvasView=b}());this.argunet=this.argunet||{};argunet.ErrorMessageView=function(f,d,a,g,e){var c=d||640;var b=a||385;if(typeof(f)=="string"){f=$(f)}if(!$(f).children(".argunetBrowser").length){$(f).append("<div class='argunetBrowser'></div>")}$(f).children(".argunetBrowser:first").width(c).height(b).empty().addClass("error").append("<div class='error'><a href='http://www.argunet.org' class='logo'><span>Argunet Browser</span></a><h3>"+g+"</h3><p>"+e+"</p><p><a href='http://www.argunet.org'>www.argunet.org</a></p></div>")};this.argunet=this.argunet||{};argunet.ArgunetBrowser=function(t,i,o,l,j,a,m,b){if(typeof t=="object"){var s=t;t=s.data;i=s.container;o=s.firstNode;l=s.width;j=s.height;a=s.jsUrl;m=s.cssUrl;b=s.embedded||true}j=j||385;m=m||"http://christianvoigt.github.com/ArgunetBrowser/lib/ArgunetBrowser.min.css";this.initialGraphDepth=1;var d=this;if(!t){$(i).children().hide()}var k=argunet.ArgunetBrowser.prototype;k.addEventListener=null;k.removeEventListener=null;k.removeAllEventListeners=null;k.dispatchEvent=null;k.hasEventListener=null;k._listeners=null;createjs.EventDispatcher.initialize(k);this.w=(b)?window.parent:window;$("#lightningjs-argunet",this.w.document).css("display","block").css("width","0").css("height","0").css("frameborder","0");this.browserId=argunet.BrowserRegistry.getInstance(this.w).registerBrowser(this);if(i){this.container=(typeof i=="string")?$(i,this.w.document).get(0):i}else{var f=argunet.BrowserRegistry.getInstance(this.w).getScriptTag(this.browserId);$(f).after("<div></div>");this.container=$(f).next("div").get(0)}if(!Modernizr.canvas||!Modernizr.canvastext||!({}).__defineGetter__){new argunet.ErrorMessageView(i,l,j,"Argunet Browser not initialized","We detected that your browser lacks features <a href='http://www.argunet.org'>Argunet Browser</a> depends on. Please use an up-to-date browser that supports HTML5, CSS3 and the Canvas Element.");return}if(!a){$("script").each(function(){var p=$(this).attr("src");
var e=-1;if(p){e=p.indexOf("ArgunetBrowser.embed.min.js")}if(e!==-1){a=$(this).attr("src").substring(0,e);return false}})}this.jsUrl=a;var q=false;$("link[type='text/css']",this.w.document).each(function(){var e=$(this).attr("src");if(e){q=(e.indexOf("ArgunetBrowser.min.css")!=-1)}if(q){return false}});if(this.jsUrl&&!q){var c=m;if(!c){c=this.jsUrl+"ArgunetBrowser.min.css"}if(this.w.document.createStyleSheet){try{this.w.document.createStyleSheet(c)}catch(r){}}else{var h;h=this.w.document.createElement("link");h.rel="stylesheet";h.type="text/css";h.media="all";h.href=c;this.w.document.getElementsByTagName("head")[0].appendChild(h)}}this.onDebateLoad=function(){this.debateListView=this.argunetView.debateListView;this.debateListController=new argunet.DebateListController(this.debateListView,this.debateManager);this.arborView=new argunet.ArborView(this.debateManager);this.argunetView.setCanvasView(this.arborView);console.log("scriptPath: "+this.jsUrl+"arbor.js");this.arborController=new argunet.ArborController(this.arborView,this.debateManager,this.jsUrl+"arbor.js");this.debateListView.addEventListener("nodeSelection",this.arborController);this.history=new argunet.History();this.arborView.addEventListener("mousedown",this.argunetView);this.argunetView.navigationBar.addEventListener("back",this.history);this.argunetView.navigationBar.addEventListener("home",this.history);this.argunetView.navigationBar.addEventListener("forward",this.history);this.argunetView.navigationBar.addEventListener("graphDepthChange",this.arborController);this.addEventListener("graphDepthChange",this.arborController);this.addEventListener("graphDepthChange",this.argunetView.navigationBar);this.argunetView.navigationBar.addEventListener("graphDepthChange",this.argunetView.navigationBar);this.arborView.addEventListener("showTooltip",this.argunetView);this.arborView.addEventListener("hideTooltip",this.argunetView);this.arborView.addEventListener("mousedown",this.argunetView);this.history.addEventListener("historyChange",this);this.history.addEventListener("historyChange",this.arborController);this.debateListView.addEventListener("nodeSelection",this);this.debateListView.addEventListener("openGroup",this.arborController);this.arborView.addEventListener("openGroup",this.arborController);this.debateListView.addEventListener("closeGroup",this.arborController);this.debateListView.addEventListener("openAllGroups",this.arborController);this.debateListView.addEventListener("closeAllGroups",this.arborController);this.arborView.addEventListener("nodeSelection",this);this.arborView.addEventListener("mousedown",this);this.arborView.addEventListener("dblclick",this);this.argunetView.removeLoadingSpinner();if(this.firstNodeId==undefined){this.firstNodeId=$.each(this.debateManager.nodes,function(){d.firstNodeId=this.id;return false})}this.initialized=true;this.selectNode(this.firstNodeId);this.setGraphDepth(this.initialGraphDepth)};this.handleEvent=function(e){if(e.type=="debateLoaded"){this.onDebateLoad()}else{if(e.type=="error"){this.argunetView.removeLoadingSpinner();new argunet.ErrorMessageView(i,l,j,"Error",e.textStatus)}else{if(e.type=="historyChange"){this.argunetView.navigationBar.setBackwardEnabled(this.history.backwardEnabled);this.argunetView.navigationBar.setForwardEnabled(this.history.forwardEnabled);this.argunetView.navigationBar.setHomeEnabled(this.history.homeEnabled)}else{if(e.type=="nodeSelection"){this.history.selectNode(e.nodeId);this.dispatchEvent({type:"nodeSelection",nodeId:e.nodeId},e.target)}else{if(e.type=="mousedown"){this.dispatchEvent(e,e.target)}else{if(e.type=="dblclick"){this.dispatchEvent(e,e.target)}}}}}}};this.selectNode=function(e){if(this.initialized){this.history.selectNode(e)}else{this.firstNodeId=e}};this.setGraphDepth=function(e){if(this.initialized){this.dispatchEvent({type:"graphDepthChange",value:e},this)}else{this.initialGraphDepth=e}};this.loadDebate=function(){this.argunetView=new argunet.ArgunetBrowserView(this.container,l,j,this.browserId);
this.firstNodeId=o;this.debateManager=new argunet.DebateManager(this.container);this.debateManager.addEventListener("debateLoaded",this);this.debateManager.addEventListener("error",this);this.debateManager.loadDebate(t)};if($(this.container).is(":hidden")){var n;var g=function(){console.log("timeout");if(!$(d.container).is(":hidden")){d.loadDebate();clearTimeout(n)}else{n=setTimeout(g,100)}};g()}else{this.loadDebate()}};lightningjs.provide("argunet",{createArgunetBrowser:lightningjs.expensive(function(a){return new argunet.ArgunetBrowser(a)})});